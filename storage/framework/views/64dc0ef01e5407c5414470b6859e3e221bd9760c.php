    ...
    <div class="card">
      <div class="card-body register-card-body">
        ...
        <form id="RegisterForm">
          ...
          <div class="input-group mb-3">
            <input type="email" id="user_type" name="user_type" class="form-control" placeholder="Enter User type">
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-user"></span>
              </div>
...
</html><?php /**PATH C:\xampp\htdocs\Al_Chisty\resources\views/Authentication/Register.blade.php ENDPATH**/ ?>