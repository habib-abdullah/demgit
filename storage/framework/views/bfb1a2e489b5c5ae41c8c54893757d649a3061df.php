      ...
      <div class="card-body login-card-body">
        ...
        <div class="row">
          <div class="col-12 mt-2">
            <p  style="text-align: center;"><a href="#">New Registration</a></p>
          </div> 
        </div>
        <div id="response"></div>
      </div>
...
</html><?php /**PATH C:\xampp\htdocs\LaravelAdminlte3-middleware\resources\views/Authentication/Login.blade.php ENDPATH**/ ?>