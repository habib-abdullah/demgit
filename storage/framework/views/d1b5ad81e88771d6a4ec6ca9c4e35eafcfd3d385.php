        ...
        <div class="card">
          ...
          <div class="card-header d-flex p-0">
            <ul class="nav nav-pills mr-auto p-2">
              ...
              <li class="nav-item"><a class="nav-link active" href="#tab_5" data-toggle="tab">MOL record</a></li>
            ...
            <form id="EmployeeStore" enctype="multipart/form-data">
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_5">
                  <div class="form-row justify-content-center mt-5">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control required" name="work_permit_no" id="work_permit_no"
                        placeholder="Employee work permit no" value="<?php echo e($employee->work_permit_no ?? ''); ?>">
                      <div class=""></div>
                    </div>
                    <div class="form-group col-md-4">
                      <label>Personal No</label>
                      <input type="text" class="form-control required" name="personal_no" id="personal_no"
                        placeholder="Employee personal no" value="<?php echo e($employee->personal_no ?? ''); ?>">
                      <div class=""></div>
                    </div>
                  </div>
                  <div class="form-row justify-content-center mt-2">
                    <div class="form-group col-md-4">
                      ...
                      <input type="date" class="form-control required" name="work_permit_expiry" id="work_permit_expiry"
                        placeholder="Employee work permit expiry" value="<?php echo e($employee->work_permit_expiry ?? ''); ?>">
                      <div class=""></div>
                    </div>
                    <div class="form-group col-md-4">
                    </div>
                  ...
                  <a href="Employee-<?php echo e($employee_id); ?>-Residency" class="btn btn-primary text-white float-left"
...
$(document).ready(function() {
  ...
  $("#btnSubmit").click(function(event) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo e(route('Employee-Mol-Record-Store')); ?>",
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/EmployeeMaster/EmployeeCreate-tab5.blade.php ENDPATH**/ ?>