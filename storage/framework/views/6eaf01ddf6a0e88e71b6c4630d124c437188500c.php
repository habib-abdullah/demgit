      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <form id="ClientStoreForm">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="client_id" id="client_id" value="<?php echo e($clients[0]->client_id); ?>">
            <div class="form-row justify-content-center mt-5">
              <div class="form-group col-md-4">
                <label>Client Name</label>
                <input type="text" class="form-control required" name="client_name" id="client_name"
                  placeholder="Enter Client Name" value="<?php echo e($clients[0]->client_name); ?>">
              </div>
              <div class="form-group col-md-4">
                <label>Company Name</label>
                <input type="text" class="form-control required" name="company_name" id="company_name"
                  placeholder="Enter Company Name" value="<?php echo e($clients[0]->company_name); ?>">
              </div>
            </div>
            <div class="form-row justify-content-center mt-3">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control required" name="code" id="code" placeholder="Enter Code"
                  value="<?php echo e($clients[0]->client_code); ?>">
              </div>
              <div class="form-group col-md-4">
                <label>Company Address</label>
                <input type="text" class="form-control required" name="company_address" id="company_address"
                  placeholder="Enter Company Address" value="<?php echo e($clients[0]->company_address); ?>">
              </div>
            </div>
            <div class="form-row justify-content-center mt-3">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control required" name="company_state" id="company_state"
                  placeholder="Enter Company State" value="<?php echo e($clients[0]->company_state); ?>">
              </div>
              <div class="form-group col-md-4">
            ...
            <div class="form-row justify-content-center mt-3">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control required " name="pobox" id="pobox" placeholder="Enter POBOX"
                  value="<?php echo e($clients[0]->pobox); ?>">
              </div>
              <div class="form-group col-md-4">
                <label>Company Fax</label>
                <input type="text" class="form-control required" name="company_fax" id="company_fax"
                  placeholder="Enter Company Fax" value="<?php echo e($clients[0]->company_fax); ?>">
              </div>
            </div>
            <div class="form-row justify-content-center mt-3">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control required" name="company_phone" id="company_phone"
                  ...
                  value="<?php echo e($clients[0]->company_phone); ?>">
              </div>
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control required" name="company_mobile" id="company_mobile"
                  ...
                  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                  value="<?php echo e($clients[0]->company_mobile); ?>">
              </div>
            </div>
            <div class="form-row justify-content-center mt-3">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control required" name="company_email" id="company_email"
                  placeholder="Enter Company Email" value="<?php echo e($clients[0]->company_email); ?>">
              </div>
              <div class="form-group col-md-4">
                <label>Company Website</label>
                <input type="text" class="form-control required" name="company_website" id="company_website"
                  placeholder="Enter Company Website" value="<?php echo e($clients[0]->company_website); ?>">
              </div>
            </div>
            <div class="form-row justify-content-center mt-3">
              <div class="form-group col-md-4">
                ...
                <select class="form-control selectBox" name="client_type" id="client_type">
                  <option selected disabled>Select</option>
                  <?php if($clients[0]->client_type == 'Client'): ?>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control required" name="balance_limit" id="balance_limit"
                  placeholder="Enter Company Balance Limit" value="<?php echo e($clients[0]->balance_limit); ?>">
              </div>
            </div>
            <div class="form-row justify-content-center mt-3">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control required" name="credit_duration" id="credit_duration"
                  placeholder="Enter Credit Duration" value="<?php echo e($clients[0]->credit_duration); ?>">
              </div>
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control required" name="trade_license_register_authority"
                  ...
                  value="<?php echo e($clients[0]->trade_license_register_authority); ?>">
            ...
            <div class="form-row justify-content-center mt-3">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control required" name="trade_license_number" id="trade_license_number"
                  placeholder="Enter Trade License Number" value="<?php echo e($clients[0]->trade_license_number); ?>">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="date" class="form-control required" name="trade_license_issue_date"
                  ...
                  value="<?php echo e($clients[0]->trade_license_issue_date); ?>">
            ...
            <div class="form-row justify-content-center mt-3">
              <div class="form-group col-md-4">
                ...
                <input type="date" class="form-control required" name="trade_license_expiry_date"
                  ...
                  value="<?php echo e($clients[0]->trade_license_expiry_date); ?>">

              </div>
              <div class="form-group col-md-4">
                <label>TRN Number</label>
                <input type="text" class="form-control required" name="trn_number" id="trn_number"
                  placeholder="Enter TRN Number" value="<?php echo e($clients[0]->trn_number); ?>">
              </div>
            </div>
            <div class="form-row justify-content-center mt-3">
              <div class="form-group col-md-4">
                ...
                <select class="form-control selectBox" name="company_site" id="company_site">
                  <option selected disabled>Select</option>
                  <?php if($clients[0]->company_site == 'main_site'): ?>
            ...
            <div class="form-row justify-content-center mt-2">
              <div class="form-group">
                ...
                <button type="button" onclick="ClientUpdate()" id="btnSubmit" class="btn btn-primary m-auto">Update
                </button>
              </div>
            </div>
...
function ClientUpdate() {
  ...
  $.ajax({
    ...
    type: "POST",
    url: "<?php echo e(route('Client-Update')); ?>",
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/Client/ClientEdit.blade.php ENDPATH**/ ?>