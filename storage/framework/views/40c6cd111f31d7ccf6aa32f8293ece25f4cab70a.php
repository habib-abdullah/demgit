            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Company Sites</div>
                        </div>
                        <div class="col-auto">
                                            ...
                                            <form id="CompanyStoreForm">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="site_name" name="site_name" autocomplete=" off" placeholder="Enter Site Name">
                                                </div>
                                                <div class="form-group">
                                                    <lable>Site Mobile</lable>
                                                    <input type="number"
                                                        class="form-control form-control-user border-primary required"
                                                        id="site_mobile" name="site_mobile" autocomplete="off" placeholder="Enter Site Mobile">
                                                </div>
                                                <div class="form-group">
                                                    <lable>Site Address</lable>
                                                    <input placeholder="Enter Site Address" type="text"
                                                        class="form-control form-control-user border-primary required"
        ...
        <div class="modal-content border-primary">
            ...
            <div class="modal-body">
                <form id="CompanyEditForm">
                    ...
                    <div class="form-group">
                        <lable>Site Name</lable>
                        <input type="text" placeholder="Enter Site Name" class="form-control form-control-user border-primary validation"
                            id="edit_name" name="edit_name" autocomplete=" off">
                    </div>
                    <div class="form-group">
                        <lable>Site Mobile</lable>
                        <input type="number" placeholder="Enter Site Mobile" class="form-control form-control-user border-primary validation"
                            id="edit_mobile" name="edit_mobile" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <lable>Site Address</lable>
                        <input type="text" placeholder="Enter Site Address" class="form-control form-control-user border-primary validation"
                            id="edit_address" name="edit_address" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <lable>Longitude</lable>
                        <input type="number" placeholder="Enter Longitude"  class="form-control form-control-user border-primary validation"
                            id="edit_longitude" name="edit_longitude" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <lable>Latitude</lable>
                        <input type="number" placeholder="Enter Latitude" class="form-control form-control-user border-primary validation"
...
$(function() {
    ...
    var tables = $("#CompanySiteTable").DataTable({
        ...
        buttons: [
            ...
            { "extend": 'excel', "text":'Export',"className": 'btn btn-default btn-sm px-4 mx-1' },
            { "extend": 'print', "text":'Print',"className": 'btn btn-default btn-sm px-4 mx-1' }
        ],
        "processing": true,
        "serverSide": true,
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchishty\resources\views/CompanySite/Comapnysite.blade.php ENDPATH**/ ?>