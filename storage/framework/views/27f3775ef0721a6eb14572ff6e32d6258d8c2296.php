                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="updateForm">
                            ...
                            <input type="hidden" class="form-control" id="user_id" name="user_id"
                                placeholder="User Name" value="<?php echo e($users[0]->user_id); ?>">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="email" class="form-control" id="user_name" name="user_name"
                                        placeholder="User Name" value="<?php echo e($users[0]->user_name); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="user_email" name="user_email"
                                        placeholder="User Email" value="<?php echo e($users[0]->user_email); ?>">
                                </div>
                            </div>
                            <div class="form-group">
...
function update() {
    $.ajax({
        type: "POST",
        url: "<?php echo e(url('Admin/Profile-Update')); ?>",
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/Admin/userProfile.blade.php ENDPATH**/ ?>