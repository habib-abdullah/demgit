                        ...
                        <form id="EmployeeStore" enctype="multipart/form-data">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab_3">
                                    <div class="form-row justify-content-center mt-5">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control required" name="passport_no"
                                                ...
                                                value="<?php echo e($employee->passport_no ?? ''); ?>">
                                            <div class=""></div>
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="form-row justify-content-center mt-2">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control required" name="mother_name"
                                                ...
                                                value="<?php echo e($employee->mother_name ?? ''); ?>">
                                        </div>
                                    </div>
                                    <div class="form-row justify-content-center mt-2">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control required" name="pp_personal_no"
                                                ...
                                                value="<?php echo e($employee->pp_personal_no ?? ''); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control required" name="nic_card_no"
                                                ...
                                                value="<?php echo e($employee->nic_card_no ?? ''); ?>">
                                        </div>
                                    </div>
                                    <div class="form-row justify-content-center mt-2">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" class="form-control required" name="nic_expiry"
                                                ...
                                                value="<?php echo e($employee->nic_expiry ?? ''); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                        </div>
                                    </div>
                                    ...
                                    <a href="Employee-<?php echo e($employee_id); ?>-Profile"
                                        class="btn btn-primary text-white float-left" style="font-size: 18px;"> Previous
                                    </a>
                                    <a href="Employee-<?php echo e($employee_id); ?>-Residency" class="btn btn-warning mx-2 px-4 float-right" style="font-size: 18px;"> Skip </a>
...
$(document).ready(function() {
    ...
    $("#btnSkip").click(function(event) {
        window.location.href = 'Employee-' + "<?php echo e($employee_id); ?>" + '-Passport';
    });
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty\resources\views/EmployeeMaster/EmployeeCreate-tab3.blade.php ENDPATH**/ ?>