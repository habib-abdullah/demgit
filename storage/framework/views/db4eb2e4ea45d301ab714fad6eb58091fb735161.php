      ...
      <div class="card shadow">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto">
              <a href="<?php echo e(route('Employe-Master-Show')); ?>" style="font-size: 22px;"><i
                      ...
                      <form id="DesignationStore">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-user border-primary"
                            placeholder="Enter designation name" id="designation" name="designation" autocomplete="off">
                        </div>
                        <div class="form-group">
                          <span class="" style="color:red; font-size: 22px; font-weight: bolder;"> * </span>
...
<div class="modal fade" id="designationEditModal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-primary">
      ...
      <div class="modal-footer">
        <span id="edit_error_area" style="display: none;" class="m-auto"></span>
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      if (data["success"] == true) {
        ...
        $('#error_area').removeClass().html('');
        $('#error_area').addClass('alert alert-danger').show().html(data['message'][0]);
        return false;
      }
    }
  });
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      if (data["success"] == true) {
        ...
        $('#edit_error_area').removeClass().html('');
        $('#edit_error_area').addClass('alert alert-danger').show().html(data['message'][0]);
        return false;
      }
    }
  });
...
function DesignationRemove(designation_id) {
  swal({
    ...
    if (willDelete) {
      $.get("<?php echo e(route('Designation-Remove')); ?>", {
        designation_id: designation_id
      }, function(data) {
        // console.log(data);
        if (data["success"] == true) {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/EmployeeMaster/Designation.blade.php ENDPATH**/ ?>