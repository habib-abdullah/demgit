            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <a href="<?php echo e(route('Client')); ?>" style="font-size: 18px;"><i
                        ...
                        <div class="form-row justify-content-center mt-3">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control required" name="code" id="code"
                                    placeholder="Enter Code" value="<?php echo e($clients[0]->client_code); ?>">
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control required" name="company_address"
                                    ...
                                    value="<?php echo e($clients[0]->company_address); ?>">
                            </div>
                        </div>
                        <div class="form-row justify-content-center mt-3">
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-row justify-content-center mt-3">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control required " name="pobox" id="pobox"
                                    placeholder="Enter POBOX" value="<?php echo e($clients[0]->pobox); ?>">
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-row justify-content-center mt-3">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control required" name="company_website"
                                    ...
                                    value="<?php echo e($clients[0]->company_website); ?>">
                            </div>
                        </div>
                        <div class="form-row justify-content-center mt-3">
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-row justify-content-center mt-3">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control required" name="credit_duration"
                                    ...
                                    value="<?php echo e($clients[0]->credit_duration); ?>">
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-row justify-content-center mt-3">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control required" name="trade_license_number"
                                    ...
                                    value="<?php echo e($clients[0]->trade_license_number); ?>">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchishty\resources\views/Client/ClientEdit.blade.php ENDPATH**/ ?>