        ...
        <div class="card">
          ...
          <div class="card-header d-flex p-0">
            ...
            <ul class="nav nav-pills mr-auto p-2">
              ...
              <li class="nav-item"><a class="nav-link active" href="#tab_3" data-toggle="tab">Passport details</a></li>
            ...
            <form id="EmployeeStore" enctype="multipart/form-data">
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_3">
                  <div class="form-row justify-content-center mt-5">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control required" name="passport_no" id="passport_no"
                        placeholder="Employee passort no" value="<?php echo e($employee->passport_no ?? ''); ?>">
                      <div class=""></div>
                    </div>
                    <div class="form-group col-md-4">
                      <label>Passport Issued Place</label>
                      <input type="text" class="form-control nationality_er requiredr" name="passport_issude_place"
                        id="passport_issude_place" placeholder="Employee passport issued place"
                        value="<?php echo e($employee->passport_issue_place ?? ''); ?>">
                    </div>
                  </div>
                  <div class="form-row justify-content-center mt-2">
                    <div class="form-group col-md-4">
                      ...
                      <input type="date" class="form-control required" name="passport_issue_date"
                        ...
                        value="<?php echo e($employee->passport_issue_date ?? ''); ?>">
                    </div>
                    <div class="form-group col-md-4">
                      ...
                      <input type="date" class="form-control required" name="passport_expiry_date"
                        ...
                        value="<?php echo e($employee->passport_expiry_date ?? ''); ?>">
                    </div>
                  </div>
                  <div class="form-row justify-content-center mt-2">
                    <div class="form-group col-md-8">
                      ...
                      <input type="text" class="form-control required" name="permanent_address_in_passport"
                        id="permanent_address_in_passport" placeholder="Employee permanent address in passport"
                        value="<?php echo e($employee->permanent_add_in_passport ?? ''); ?>">
                    </div>
                  </div>
                  <div class="form-row justify-content-center mt-2">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control required" name="father_name" id="father_name"
                        placeholder="Employee father name" value="<?php echo e($employee->father_name ?? ''); ?>">
                    </div>
                    <div class="form-group col-md-4">
                      <label>Mother Name</label>
                      <input type="text" class="form-control required" name="mother_name" id="mother_name"
                        placeholder="Employee mother name" value="<?php echo e($employee->mother_name ?? ''); ?>">
                    </div>
                  </div>
                  <div class="form-row justify-content-center mt-2">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control required" name="pp_personal_no" id="pp_personal_no"
                        placeholder="Employee PP personal no" value="<?php echo e($employee->pp_personal_no ?? ''); ?>">
                    </div>
                    <div class="form-group col-md-4">
                      <label>NIC Card No</label>
                      <input type="text" class="form-control required" name="nic_card_no" id="nic_card_no"
                        placeholder="Employee NIC Card No" value="<?php echo e($employee->nic_card_no ?? ''); ?>">
                    </div>
                  </div>
                  <div class="form-row justify-content-center mt-2">
                    <div class="form-group col-md-4">
                      ...
                      <input type="date" class="form-control required" name="nic_expiry" id="nic_expiry"
                        placeholder="Employee NIC expiry" value="<?php echo e($employee->nic_expiry ?? ''); ?>">
                    </div>
                    <div class="form-group col-md-4">
                    </div>
                  </div>
                  ...
                  <a href="Employee-<?php echo e($employee_id); ?>-Profile" class="btn btn-primary text-white float-left"
...
$(document).ready(function() {
  ...
  $("#btnSubmit").click(function(event) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo e(route('Employee-Passport-Store')); ?>",
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/EmployeeMaster/EmployeeCreate-tab3.blade.php ENDPATH**/ ?>