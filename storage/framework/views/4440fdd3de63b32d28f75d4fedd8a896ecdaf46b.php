...
<div class="card  card-primary">
    <div class="card-header bg-gradient-info">
        <h3>Master Distributor Report</h3>
            ...
            <div class="modal-body">
                <form id="TransferForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="main_amount" name="main_amount"
...
$(document).ready(function() {
    $('#table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(url('MasterDistReport')); ?>",
        columns: [{
                data: 'member_id'
            },
            {
...
function RemoveMaster(id) {
    ...
    if (verifyOk == true) {
        $.post("<?php echo e(url('RemoveMaster')); ?>", {
            id: id
        }, function(data) {
            console.log(data);
...
function GetMasterId(id) {
    $.get("<?php echo e(url('GetMasterId')); ?>", {
        master_id: id
    }, function(data) {
        // console.log(data);
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PerfectRecharge\resources\views/Member/MasterDistributor.blade.php ENDPATH**/ ?>