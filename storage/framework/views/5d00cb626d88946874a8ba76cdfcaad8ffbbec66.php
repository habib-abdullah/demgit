      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item main_active ">
              <a href="<?php echo e(url('ProductPurchase')); ?>" class="nav-link">
                <i class="nav-icon fas fa-home"></i>
                <p>Product Purchase</p>
              </a>
            </li>
            <li class="nav-item main_active ">
              <a href="<?php echo e(url('ProductPurchaseList')); ?>" class="nav-link">
                <i class="nav-icon fas fa-home"></i>
                <p>Product Purchase List</p>
              </a>
            </li>
            <li class="nav-item main_active ">
              <a href="<?php echo e(url('ProductSale')); ?>" class="nav-link">
                <i class="nav-icon fas fa-home"></i>
                <p>Product Sale</p>
              </a>
            </li>
...
</html><?php /**PATH C:\xampp\htdocs\LaravelAdminlte3-middleware\resources\views/layout.blade.php ENDPATH**/ ?>