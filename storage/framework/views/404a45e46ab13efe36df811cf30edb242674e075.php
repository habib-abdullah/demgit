  ...
  <script type="text/javascript">
        ...
        var tables = $("#DataTable").DataTable({
            ...
            [
                ...
                {data : 'bank_passbook_image',
                  ...
                  return '<img src="<?php echo e(url("public/Employee/Bank_Pasbook_Images")); ?>/'+data+'" style="width:70px;height:auto;">';
              }
    ...
    { 
      ...
      .then((willDelete) => {
        if (willDelete) 
        {
          $.get("<?php echo e(route('Employee-Bank-Remove')); ?>",{id:id},function(data){
            console.log(data);
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Al_Chisty\resources\views/EmployeeBank/Bank.blade.php ENDPATH**/ ?>