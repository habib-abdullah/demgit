                    ...
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#UOMStoreModal">Add UOM</button>
                                            ...
                                            <form id="UOMStoreForm">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="uom_name" name="uom_name" placeholder="Enter your uom name" autocomplete=" off" placeholder="Enter your uom name">
                                                </div>
                                                <div class="form-group">
                                                    <lable>Code</lable>
                                                    <input type="text"
                                                        class="form-control form-control-user border-primary required"
                                                        id="uom_code" name="uom_code" autocomplete="off" placeholder="Enter your uom code">
                                                </div>
                                            </form>
                                        </div>
                ...
                <form id="UOMEditForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-user border-primary uom_input "
                            id="uoms_name" name="uom_name" autocomplete=" off" placeholder="Enter your uom name">
                    </div>
                    <div class="form-group">
                        <lable>Code</lable>
                        <input type="text" class="form-control form-control-user border-primary uom_input"
                            id="uoms_code" name="uom_code" autocomplete="off" placeholder="Enter your uom code">
                    </div>
                    <div class="form-group">
                        <lable>Code</lable>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchishty\resources\views/Setup/UOM.blade.php ENDPATH**/ ?>