        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            ...
            <!-- <div class="col-auto">
              ...
              <a href="<?php echo e(url('Admin/Employee-Document-Create')); ?>" class="btn btn-primary">Add Documents</a>
            </div> -->
          </div>
        </div>
      </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/EmployeeMaster/EmployeeDocumentsList.blade.php ENDPATH**/ ?>