...
<div class="card card-outline card-primary  " >
        <div class="card-header" >
            <h3 class="card-title pt-2">Update Retailer</h3>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="card-body bg-grey">
                        <input type="hidden" name="retailer_id" id="retailer_id" value="<?php echo e($row[0]->member_id); ?>">
                        <?php if(Session::get('type_id')==3 || Session::get('type_id')==2): ?>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">
                                Member Parent: (Distributor)
                            </label>
                            <select class="form-control" id="member_parent" name="member_parent">
                                <option selected disabled>Select Member</option>
                                <?php foreach($distributors as $distributor):?>
                                    <?php if($row[0]->member_parent == $distributor->member_id):?>   
                                        <option selected value="<?php echo e($distributor->member_id); ?>">
                                        <?php echo e($distributor->member_id); ?> <?php echo e($distributor->member_name); ?></option>
                                    <?php else:?>
                                        <option value="<?php echo e($distributor->member_id); ?>">
                                        <?php echo e($distributor->member_id); ?> <?php echo e($distributor->member_name); ?></option>
                                    <?php endif;?>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="card-body bg-grey">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" value="<?php echo e($row[0]->member_password); ?>"  name="member_password" class="form-control" id="member_password" >
                            </div>
                            <div id=""></div>
                        </div>
                    </div>
                        <div class="mx-auto" style="margin-bottom: 15px;">
                            <button type="button" id="btnSave" class="btn btn-primary" onclick="UpdateRetailer()">Submit</button>
...
<script>
    ...
    // return false;
        ...
        //     member_mobile == "" || member_amount == "" || member_address == "")
        // {
        ...
        $.ajax({
            type:'POST',
            url:"<?php echo e(url('UpdateRetailer')); ?>",
            ...
            success:function(data){
                ...
                if(data.includes('Updated Successfully')){
                    window.location.href = "<?php echo e(url('Retailer')); ?>";
                }
            }
        });
    }
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PerfectRecharge\resources\views/Member/UpdateRetailer.blade.php ENDPATH**/ ?>