...
$('#submitBtn').click(function() {
  ...
  $.ajax({
    ...
    type: "POST",
    url: "<?php echo e(route('Client-Document-Store')); ?>",
    data: new_data,
    processData: false,
    contentType: false,
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/Client/ClientDocuments.blade.php ENDPATH**/ ?>