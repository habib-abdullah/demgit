                        ...
                        <form id="EmployeeStore" enctype="multipart/form-data">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab_7">
                                    <div class="form-row justify-content-center mt-5">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" class="form-control contact_required"
                                                ...
                                                placeholder="Employee contact" value="<?php echo e($employee->contact ?? ''); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="form-row justify-content-center mt-2">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control contact_required"
                                                ...
                                                placeholder="Employee imo no" value="<?php echo e($employee->imo_no ?? ''); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label>Facebook</label>
                                            <input type="text" class="form-control contact_required"
                                                name="employee_facebook" id="employee_facebook"
                                                placeholder="Employee facebook" value="<?php echo e($employee->facebook ?? ''); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <a href="Employee-<?php echo e($employee_id); ?>-Bank"
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchishty\resources\views/EmployeeMaster/EmployeeCreate-tab7.blade.php ENDPATH**/ ?>