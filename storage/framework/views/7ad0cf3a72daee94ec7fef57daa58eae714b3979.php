                    ...
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#SalesOrderStoreModal">Add Order</button>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                autocomplete="off" placeholder="Enter Contact Person Number">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                autocomplete="off" placeholder="Enter Focus SO">
                                                        </div>
                                                    </div>
                                                </div>
...
function SalesOrderEdit(sales_order_id) {
    ...
    $.get(url_edit, function(data) {
        ...
        // $("#order_date").val(data[0]['sales_order_date']);
        // $("#sales_mode").val(data[0]['sales_mode']);
        // $("#edit_customer_by").val(data[0]['company_name']);
        // $("#person_name").val(data[0]['sales_person_name']);
        // $("#person_number").val(data[0]['sales_person_number']);
        // $("#receiving_date").val(data[0]['sales_receiving_date']);
        // $("#delivery_date").val(data[0]['sales_delivery_date']);
        // $("#lpo").val(data[0]['sales_lpo']);
        // $("#focus_so").val(data[0]['sales_focus_so']);
        // $("#order_subject").val(data[0]['sales_order_subject']);
        // $("#customer_by").val(data[0]['customer_id']);
        // $("#booked_by_id").val(data[0]['customer_id']);

        $("#SaleOrderBody").html(data);
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty\resources\views/SalesOrder/SalesOrder.blade.php ENDPATH**/ ?>