          ...
          <div class="card-body">
            <form id="EmployeeStore" enctype="multipart/form-data">
              <div class="tab-content">
                ...
                <input type="hidden" class="form-control" id="employee_id" name="employee_id" value="<?php echo e($employee_id); ?>">
                <div class="tab-pane active" id="tab_8">
                  ...
                  <div class="form-row justify-content-center mt-2">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control required" name="account_name" id="account_name"
                        placeholder="Employee account name">
                    </div>
                    <div class="form-group col-md-4">
                  ...
                  <div class="form-row justify-content-center mt-2">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control required" name="account_type" id="account_type"
                        placeholder="Employee account type">
                    </div>
                    <div class="form-group col-md-4">
                      <label>IBAN</label>
                  ...
                  <a id="btnUpdate" class="btn btn-warning float-right" style="font-size: 18px; display:none;">Update
                    Bank & Next </a>
                </div>
              </div>
            </form>
...
$(function() {
  // $.get("<?php echo e(route('Bank-Account-Detail')); ?>",{employee_id:"<?php echo e($employee_id); ?>"},function(data){
  // 	console.log(data);
  // });
  var tables = $("#dataTable").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: "<?php echo e(route('Bank-Account-Detail')); ?>",
      data: {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/EmployeeMaster/EmployeeCreate-tab8.blade.php ENDPATH**/ ?>