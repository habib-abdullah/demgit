            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item main_active ">
                            <a href="<?php echo e(url('Admin/CompanySite')); ?>" class="nav-link">
                ...
                <p>Master Dashboard</p>
                        ...
                        <li class="nav-item has-treeview main_active ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item main_active ">
                                    <a href="<?php echo e(route('UOM')); ?>" class="nav-link">
                                        <i class="nav-icon fas fa-glass-martini-alt"></i>
                                        <p>UOM</p>
                                    </a>
                                </li>
                                <li class="nav-item main_active ">
                                    <a href="<?php echo e(route('Operation')); ?>" class="nav-link">
                                ...
                                <li class="nav-item main_active ">
                                    <a href="<?php echo e(route('Machine')); ?>" class="nav-link">
                                        <i class="nav-icon fas fa-industry"></i>
                                        <p>Machine</p>
                                    </a>
                                </li>
                                <li class="nav-item main_active ">
                                    <a href="<?php echo e(route('Shift')); ?>" class="nav-link">
                        ...
                        <li class="nav-item has-treeview main_active ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item main_active ">
                                    <a href="<?php echo e(route('Items-Grades')); ?>" class="nav-link">
                                        <i class="nav-icon fas fa-circle"></i>
                                        <p>Items Grades</p>
                                    </a>
                                </li>
                                <li class="nav-item main_active ">
                                    <a href="<?php echo e(route('Items-Sizes')); ?>" class="nav-link">
                                        <i class="nav-icon fas fa-circle"></i>
                                        <p>Item Sizes</p>
                                    </a>
                                </li>
                                <li class="nav-item main_active ">
                                    <a href="<?php echo e(route('Items')); ?>" class="nav-link">
                                        <i class="nav-icon fas fa-circle"></i>
                                        <p>Items</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview main_active ">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item main_active ">
                                    <a href="<?php echo e(route('Employee-Shifts')); ?>" class="nav-link">
                                        <i class="nav-icon fas fa-circle"></i>
                                        <p>Shifts</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item main_active ">
                            <a href="<?php echo e(route('Visitor-Log')); ?>" class="nav-link">
                        ...
                        <li class="nav-item main_active ">
                            <a href="<?php echo e(route('Purchase')); ?>" class="nav-link">
                                <i class="nav-icon fas fa-shopping-cart"></i>
                                <p>Purchase</p>
                            </a>
                        </li>
                        <li class="nav-item main_active ">
                            <a href="<?php echo e(route('Sales-Order')); ?>" class="nav-link">
...
</html><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/layout.blade.php ENDPATH**/ ?>