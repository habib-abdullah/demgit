                    ...
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#ItemStoreModal">Add</button>
                                            ...
                                            <form id="ItemStoreForm">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="size_id" id="size_id"
                                                        ...
                                                        <option value="<?php echo e($size->size_id); ?>"><?php echo e($size->size_title); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="grade_id" id="grade_id"
                                                        ...
                                                        <option value="<?php echo e($grade->grade_id); ?>"><?php echo e($grade->grade_title); ?>
                ...
                <form id="ItemEditForm">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="size_id" id="sizes_id" style="width: 100%;">
                            ...
                            <?php if(count($sizes) > 0): ?>
                            <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($size->size_id); ?>"><?php echo e($size->size_title); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </select>
                    </div>
...
$(function() {
    ...
    var tables = $("#ItemDataTable").DataTable({
        ...
        "serverSide": true,
        ajax: {
            url: "<?php echo e(route('Item-Show')); ?>",
            // data: {
            //   client_id: ""
            // }
        },
...
function ItemStore() {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(route('Item-Store')); ?>",
...
function ItemRemove(item_id) {
    swal({
        ...
        if (willDelete) {
            $.get("<?php echo e(route('Item-Remove')); ?>", {
                item_id: item_id
            }, function(data) {
                console.log(data);
                // return false;
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/Inventory/Item.blade.php ENDPATH**/ ?>