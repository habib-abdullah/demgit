          ...
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto">
              <button type="button" class="btn btn-primary" data-toggle="modal"
                data-target="#MachineStoreModal">Add</button>
                      ...
                      <form id="MachineStoreForm">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-user border-primary required "
                            id="machine_name" name="machine_name" autocomplete=" off" placeholder="Enter machine name">
                        </div>
                        <div class="form-group">
                          <lable>Code</lable>
                          <input type="text" class="form-control form-control-user border-primary required"
                            id="machine_code" name="machine_code" autocomplete="off" placeholder="Enter machine code">
                        </div>
                        <div class="form-group">
                          <lable>Title</lable>
                          <input type="text" class="form-control form-control-user border-primary required "
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-user border-primary required"
                            id="machine_description" name="machine_description" autocomplete="off"
                            placeholder="Enter machine description">
                        </div>
                        <div class="form-group">
                          <lable>Hour Rate</lable>
                          <input type="text" class="form-control form-control-user border-primary required "
                            id="machine_hour_rate" name="machine_hour_rate" autocomplete=" off"
                            placeholder="Enter machine our rate">
                        </div>
                        <div class="form-group">
                          <lable>Department</lable>
                          <select class="form-control select2" name="DepartmentSelector" id="DepartmentSelector"
                            style="width: 100%;">
    ...
    <div class="modal-content border-primary">
      ...
      <div class="modal-body">
        <form id="MachineEditForm">
          ...
          <div class="form-group">
            <lable>Name</lable>
            <input type="text" class="form-control form-control-user border-primary machine_input " id="machines_name"
              name="machine_name" autocomplete=" off" placeholder="Enter machine name">
          </div>
          <div class="form-group">
            <lable>Code</lable>
            <input type="text" class="form-control form-control-user border-primary machine_input" id="machines_code"
              name="machine_code" autocomplete="off" placeholder="Enter machine code">
          </div>
          <div class="form-group">
            <lable>Title</lable>
            <input type="text" class="form-control form-control-user border-primary machine_input " id="machines_title"
              name="machine_title" autocomplete=" off" placeholder="Enter machine title ">
          </div>
          <div class="form-group">
            <lable>Make</lable>
            <input type="text" class="form-control form-control-user border-primary machine_input" id="machines_make"
              name="machine_make" autocomplete="off" placeholder="Enter machine description">
          </div>
          <div class="form-group">
            <lable>Model</lable>
            <input type="text" class="form-control form-control-user border-primary machine_input" id="machines_model"
              name="machine_model" autocomplete="off" placeholder="Enter machine description">
          </div>
          <div class="form-group">
            <lable>Description</lable>
          ...
          <div class="form-group">
            <lable>Hour Rate</lable>
            <input type="text" class="form-control form-control-user border-primary machine_input "
              id="machines_hour_rate" name="machine_hour_rate" autocomplete=" off" placeholder="Enter machine our rate">
          </div>
          <div class="form-group">
            <lable>Department</lable>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/Setup/Machine.blade.php ENDPATH**/ ?>