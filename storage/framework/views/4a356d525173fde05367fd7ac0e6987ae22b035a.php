...
<form id="sale_form">
  ...
  <div class="form-group row">
    ...
    <select id="customer_name" name="customer_name" class=" form-control col-sm-10">
      ...
      <option value="<?php echo e($row->customer_id); ?>"><?php echo e($row->customer_name); ?></option>
  ...
  <div class="form-group row">
    <div class="col-sm-10">
      <button type="button" onclick="sale()" class="btn btn-primary">Submit</button>
    </div>
  </div>
</form>
...
function sale() {
  $.post("<?php echo e(url('sale')); ?>", $("#sale_form").serialize(), function(data) {
    console.log(data);
  });
}
</script>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LaravelAdminlte3\resources\views/ProductSale.blade.php ENDPATH**/ ?>