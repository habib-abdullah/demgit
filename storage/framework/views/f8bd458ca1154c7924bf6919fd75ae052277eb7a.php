          ...
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto">
              <button type="button" class="btn btn-primary" data-toggle="modal"
                data-target="#SizeStoreModal">Add</button>
                      ...
                      <form id="SizeStoreForm">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-user border-primary required "
                            id="size_title" name="size_title" autocomplete=" off" placeholder="Enter size title">
                        </div>
                        <div class="form-group">
    ...
    <div class="modal-content border-primary">
      ...
      <div class="modal-body">
        <form id="SizeEditForm">
          ...
          <div class="form-group">
            <lable>Size Title</lable>
            <input type="text" class="form-control form-control-user border-primary size_input " id="sizes_title"
              name="size_title" autocomplete=" off" placeholder="Enter size title">
          </div>
          <div class="form-group">
            <lable>Description</lable>
            <input type="text" class="form-control form-control-user border-primary size_input" id="sizes_description"
              name="size_description" autocomplete="off" placeholder="Enter size description">
          </div>
          <div class="form-group">
            <lable>Status</lable>
...
function SizeUpdate() {
  ...
  for (let i = 0; i <= fields.length; i++) {
    ...
    if ($(fields[i]).val() === '') {
      ...
      $("#size_edit_show_error").show().addClass('alert alert-danger').html('The ' + value + ' field is required.');
      return false;
    } else {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/Inventory/Size.blade.php ENDPATH**/ ?>