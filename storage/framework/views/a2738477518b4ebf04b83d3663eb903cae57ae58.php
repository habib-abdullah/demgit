          ...
          <div class="col-md-6">
            <div class="card-body box-profile">
              ...
              <ul class="list-group list-group-unbordered mb-3">
                ...
                <li class="" style="list-style:none;">
                  <b>Current Status</b> <a class="float-right"><?php echo e($clients[0]->status == 1 ? 'Active' : "Inactive"); ?></a>
                  <hr>
                </li>
              </ul>
            </div>
        ...
        <div class="card-body box-profile p-0">
          <div class="tab-content">
            ...
            <div class="tab-pane " id="tab_2">
              <div class="col-lg-11">
                <div class="table-responsive mb-5">
                  <div class="table-responsive">
                    <table id="SalesDataTable" class="table table-bordered" width="100%" cellspacing="0">
                      <thead>
                        <tr>
                          <th>Date</th>
                          <th>Sr No</th>
            ...
            <div class="tab-pane " id="tab_4">
              <div class="col-lg-11">
                <div class="table-responsive">
                  <button class="btn btn-primary m-2 px-3" data-toggle="modal" data-target="#addContactModal">Add
                    Contact</button>
                  <div class="table-responsive">
                    <table id="ContactDataTable" class="table table-bordered" width="100%" cellspacing="0">
                      <thead>
                        <tr>
                          <th>Designation</th>
                          <th>Name</th>
            ...
            <div class="tab-pane " id="tab_5">
              <div class="col-lg-11">
                <div class="table-responsive">
                  <button class="btn btn-primary m-2 px-3" data-toggle="modal" data-target="#addBankModal">Add
                    Bank</button>
                  <div class="table-responsive">
                    <table id="BankDataTable" class="table table-bordered" width="100%" cellspacing="0">
                      <thead>
                        <tr>
                          <th>Bank Name</th>
                          <th>Branch</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><Button type="button" id="" class="btnRemove btn btn-danger"
                          value="<?php echo e($document->document_id); ?>"><i class="fas fa-trash"></i></Button></td>
    ...
    <div class="modal-content border-primary">
      ...
      <div class="modal-body">
        <form id="ContactStoreForm">
          ...
          <div class="form-group">
            ...
            <label>Alias</label>
            <input type="text" class="form-control form-control-user border-primary required"
              placeholder="Enter contact alias" id="contact_alias" name="contact_alias" autocomplete="off">
          </div>
          <div class="form-group">
            <!-- <span class="" style="color:red; font-size: 22px; font-weight: bolder;"> * </span> -->
            <label>Mobile</label>
            <input type="text" class="form-control form-control-user border-primary required"
              placeholder="Enter contact mobile" id="contact_mobile" name="contact_mobile" autocomplete="off"
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control form-control-user border-primary required"
              placeholder="Enter contact email" id="contact_email" name="contact_email" autocomplete="off">
          </div>
      ...
      <div>
        <div class="modal-footer">
          ...
          <button type="button" id="btnSubmit" onclick="ContactStore()" class="btn btn-primary">Submit</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content border-primary">
        ...
        <form id="ContactEditForm">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-user border-primary contact_input"
              placeholder="Enter contact designation" id="contacts_designation" name="contacts_designation"
              autocomplete="off">
          </div>
          <div class="form-group">
            <!-- <span class="" style="color:red; font-size: 22px; font-weight: bolder;"> * </span> -->
          ...
          <div class="form-group">
            ...
            <label>Alias</label>
            <input type="text" class="form-control form-control-user border-primary contact_input"
              placeholder="Enter contact alias" id="contacts_alias" name="contacts_alias" autocomplete="off">
          </div>
          <div class="form-group">
            <!-- <span class="" style="color:red; font-size: 22px; font-weight: bolder;"> * </span> -->
            <label>Mobile</label>
            <input type="text" class="form-control form-control-user border-primary contact_input"
              placeholder="Enter contact mobile" id="contacts_mobile" name="contacts_mobile" autocomplete="off"
              onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
          </div>
          <div class="form-group">
            <!-- <span class="" style="color:red; font-size: 22px; font-weight: bolder;"> * </span> -->
            <label>Phone</label>
            <input type="text" class="form-control form-control-user border-primary contact_input"
              placeholder="Enter contact phone" id="contacts_phone" name="contacts_phone" autocomplete="off"
              onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
          </div>
          <div class="form-group">
            <!-- <span class="" style="color:red; font-size: 22px; font-weight: bolder;"> * </span> -->
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control form-control-user border-primary contact_input"
              placeholder="Enter contact email" id="contacts_email" name="contacts_email" autocomplete="off">
          </div>
      ...
      <div>
        <div class="modal-footer">
          <span id="error_area" style="display: none;" class="m-auto"></span>
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="button" id="btnUpdate" onclick="ContactUpdate()" class="btn btn-primary">Update</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content border-primary">
      ...
      <div class="modal-body">
        <form id="BankStoreForm">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-user border-primary bank_mandatory"
              placeholder="Enter account number" id="account_number" name="account_number" autocomplete="off">
          </div>
          <div class="form-group">
            <label>Branch</label>
            <input type="text" class="form-control form-control-user border-primary bank_mandatory"
      ...
      <div>
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="button" id="btnSubmitBank" onclick="BankStore()" class="btn btn-primary">Submit</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content border-primary">
      ...
      <div class="modal-body">
        <form id="BankEditForm">
          ...
          <div class="form-group">
            <label>Account Number</label>
            <input type="text" class="form-control form-control-user border-primary bank_edit_input"
              placeholder="Enter account number" id="accounts_number" name="accounts_number" autocomplete="off">
          </div>
          <div class="form-group">
            <label>Branch</label>
            <input type="text" class="form-control form-control-user border-primary bank_edit_input"
      ...
      <div>
        <div class="modal-footer">
          <span id="" style="display: none;" class="m-auto"></span>
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="button" id="btnBankUpdate" onclick="BankUpdate()" class="btn btn-primary">Update</button>
        </div>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty\resources\views/Client/ClientProfile.blade.php ENDPATH**/ ?>