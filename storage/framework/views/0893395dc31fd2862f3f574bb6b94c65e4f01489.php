              ...
              <div class="col-md-6">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="fees" class="form-control" id="fees" placeholder="Enter Fees Amount">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">UPSC Prelim Already Attemp</label>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hcoi\resources\views/NewAdmission.blade.php ENDPATH**/ ?>