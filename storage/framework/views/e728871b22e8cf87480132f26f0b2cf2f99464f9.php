                                ...
                                <div class="tab-pane active " id="tab_2">
                                    ...
                                    <div class="form-row justify-content-center mt-3">
                                        ...
                                        <div class="form-group col-md-4 mt-5">
                                            <img src="<?php echo e(url('public/crop_image/')); ?>/<?php echo e($employee[0]->emp_profile_img); ?>"
                                    ...
                                    <a href="Employee-<?php echo e($employee_id); ?>-Edit-Detail"
                                        class="btn btn-primary text-white float-left" style="font-size: 18px;"> Previous
                                    </a>
                                    <a href="Employee-<?php echo e($employee_id); ?>-Passport" class="btn btn-warning mx-2 px-4 float-right" style="font-size: 18px;"> Skip </a>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty\resources\views/EmployeeMaster/EmployeeCreate-tab2.blade.php ENDPATH**/ ?>