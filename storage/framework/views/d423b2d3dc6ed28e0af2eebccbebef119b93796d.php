                        ...
                        <form id="EmployeeStore" enctype="multipart/form-data">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab_8">
                                    ...
                                    <a href="Employee-<?php echo e($employee_id); ?>-Contact"
                                        class="btn btn-primary text-white float-left" style="font-size: 18px;"> Previous
                                    </a>
                                    <a href="Employee-<?php echo e($employee_id); ?>-Login-Detail"
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty\resources\views/EmployeeMaster/EmployeeCreate-tab8.blade.php ENDPATH**/ ?>