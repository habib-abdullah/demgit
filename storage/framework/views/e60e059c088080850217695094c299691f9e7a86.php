<form id="DesignationUpdate">
  <?php echo csrf_field(); ?>
  <input type="hidden" class="form-control" id="designation_id" name="designation_id" value="<?php echo e($row->designation_id); ?>">
  <div class="form-group">
    <span class="" style="color:red; font-size: 22px; font-weight: bolder;"> * </span>
    <label>Designation</label>
    <input type="text" class="form-control form-control-user border-primary" value="<?php echo e($row->designation_name); ?>"
  ...
  <div class="form-group">
    ...
    <select class="form-control" name="working_site" id="working_site">
      <?php if($row->working_site == 'main_site'): ?>
...
</form><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/EmployeeMaster/DesignationEdit.blade.php ENDPATH**/ ?>