				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="card-body bg-grey">
							<input type="text" name="master_id" id="master_id" value="<?php echo e($row[0]->member_id); ?>">
						...
						<div class="col-xl-6">
							...
							<div class="mx-auto" style="margin-bottom: 15px;">
								<button type="button" id="btnSave" class="btn btn-primary" onclick="UpdateMaster()">Submit</button>
...
// return false;
	...
	$.ajax({
		type:'POST',
		url:"<?php echo e(url('UpdateMaster')); ?>",
		...
		success:function(data){
			...
			if(data.includes('Updated Successfully')){
				window.location.href = "<?php echo e(url('MasterDistributor')); ?>";
			}
		}
	});
}
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PerfectRecharge\resources\views/Member/UpdateMasterdist.blade.php ENDPATH**/ ?>