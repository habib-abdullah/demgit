          ...
          <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
              <div class="card-header">
                <h3 class="card-title">
                  <a href="<?php echo e(route('Employee-Contact-Detail-Show')); ?>" style="font-size: 18px;"><i class="fas fa-arrow-circle-left"></i></a> Add Employee Contact Detail
                </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="EmployeeContactDetailForm">
                ...
                <div class="form-group col-md-4">
                      ...
                      <option value="<?php echo e($rows->employee_id); ?>"><?php echo e($rows->first_name); ?> <?php echo e($rows->last_name); ?></option>
                  ...
                  <label>Employee Email</label>
                    <input type="email" class="form-control emp_email_err" name="emp_email" id="emp_email" placeholder="Enter Employee Email Address">
                ...
                <div class="form-row justify-content-center mt-2">
                  ...
                  <div class="form-group col-md-4">
                      ...
                      <input type="number" class="form-control emp_cont_err" name="emp_con_no" id="emp_con_no" placeholder="Enter Contact Number">
                      <div class="emp_cont_err_msg"></div>
                  </div>

                  <div class="form-group col-md-4">
                     <label>WhatsApp no</label>
                     <input type="number" class="form-control emp_whatsapp_no_err" name="emp_whatsapp_no" id="emp_whatsapp_no" placeholder="Enter WhatsApp Number">
                ...
                <div class="form-row justify-content-center mt-2">
                  <div class="form-group col-md-4">
                      <label>Imo no</label>
                      <input type="text" class="form-control emp_imo_no_err" name="emp_imo_no" id="emp_imo_no" placeholder="Enter Imo Number">
                      <div class="emp_imo_no_err_msg"></div>
                  </div>

                  <div class="form-group col-md-4">
                      <label>Facebook Id</label>
                      <input type="text" class="form-control emp_fb_id_err" name="emp_fb_id" id="emp_fb_id" placeholder="Enter Facebook Id">
                ...
                <div class="form-row justify-content-center mt-2">     
                  <div class="form-group col-md-4">
                     ...
                     <input type="text" class="form-control emp_per_con_name_err" name="emp_per_con_name" id="emp_per_con_name" placeholder="Enter Permanent Contact Name">
                     <div class="emp_per_con_name_err_msg"></div>
                  </div>
                  <div class="form-group col-md-4">
                      <label>Permanent Contact no</label>
                      <input type="number" class="form-control emp_per_con_no_err" name="emp_per_con_no" id="emp_per_con_no" placeholder="Enter Permanent Contact no">
               ...
               <div class="form-row justify-content-center mt-2">     
                  <div class="form-group col-md-4">
                     ...
                     <input type="text" class="form-control emp_per_con_rel_err" name="emp_per_con_rel" id="emp_per_con_rel" placeholder="Enter Permanent Contact Relation">
                     <div class="emp_per_con_rel_err_msg"></div>
                  </div>
                  <div class="form-group col-md-4">
                      <label>UAE Emergency Contact no</label>
                      <input type="number" class="form-control emp_uae_con_no_err" name="emp_uae_con_no" id="emp_uae_con_no" placeholder="Enter UAE Emergency Contact no">
               ...
               <div class="form-row justify-content-center mt-2">     
                  <div class="form-group col-md-4">
                     ...
                     <input type="text" class="form-control emp_uae_con_name_err" name="emp_uae_con_name" id="emp_uae_con_name" placeholder="Enter UAE Contact Name">
                     <div class="emp_uae_con_name_err_msg"></div>
                  </div>
                  <div class="form-group col-md-4">
                      <label>UAE Contact Relation</label>
                      <input type="text" class="form-control emp_uae_con_rel_err" name="emp_uae_con_rel" id="emp_uae_con_rel" placeholder="Enter UAE Contact Relation">
               ...
               <div class="form-row justify-content-center mt-2">     
                  <div class="form-group col-md-4">
                     ...
                     <input type="text" class="form-control emp_uae_per_add_err" name="emp_uae_per_add" id="emp_uae_per_add" placeholder="Enter UAE Permanent Address">
                     <div class="emp_uae_per_add_err_msg"></div>
                  </div>
                  <div class="form-group col-md-4" style="margin-top: 30px;">
                        <button  type="button" onclick="EmployeeContactStore()" id="emp_contact_submit" class="btn btn-primary pr-4 pl-4" >Submit
                        </button>
        ...
        $('#emp_name').on('change', function () 
      {
        ...
        $('#emp_profile_img').append(``);
          ...
          response.forEach(element => {
              $('#emp_profile_img').append(`<img src="http://localhost/Al_Chisty/public/crop_image/${element['emp_profile_img']}" alt="No image available" style="width:100px;height:auto;">`);
              });
          }
        });
    });
  ...
  function EmployeeContactStore()
  {
    ...
    var email_val = $("#emp_email").val();
        if (email_val == "")
        {
          ...
          $("#emp_contact_error_area").addClass("alert alert-danger").html("All Filed Must be required..").css({"color": "#fff"});
          return false;
        }  
        else
        {
          ...
          $("#emp_contact_error_area").removeClass("alert alert-danger").html("").css({"color": "#fff"});
        }
      ...
      $.ajax({
        ...
        type : "POST",
        url : "<?php echo e(route('Employee-Contact-Store')); ?>",
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/EmployeeMaster/addEmployeeContactDetail.blade.php ENDPATH**/ ?>