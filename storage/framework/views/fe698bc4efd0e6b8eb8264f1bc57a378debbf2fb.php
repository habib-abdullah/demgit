            ...
            <form id="EmployeeStore" enctype="multipart/form-data">
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_9">
                  ...
                  <a href="Employee-<?php echo e($employee_id); ?>-Bank" class="btn btn-primary text-white float-left"
                    style="font-size: 18px;"> Previous
                  </a>
                  <a href="<?php echo e(route('Employe-Master-Show')); ?>" class="btn btn-warning mx-2 px-4 float-right"
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty\resources\views/EmployeeMaster/EmployeeCreate-tab9.blade.php ENDPATH**/ ?>