...
<div class="register-box">
  <div class="register-logo">
    <a href="../../index2.html"><b>Perfect</b>Recharge</a>
  </div>
    ...
    <div class="card-body register-card-body">
      ...
      <form id="RegisterForm">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <a  onclick="RegisterUser()" class="btn btn-primary text-white btn-block">Register</a>
          </div>
          <!-- /.col -->
...
<?php /**PATH C:\xampp\htdocs\PerfectRecharge1\resources\views/Authentication/register.blade.php ENDPATH**/ ?>