                    ...
                    <div class="card bg-light shadow-md border-0 rounded-lg">
                        <div class="card-body p-5">
                            <form id="UpdateForm">
                                ...
                                <div class="form-group mt-4 mb-0"><a class="btn btn-success text-white"
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PerfectRecharge\resources\views/Recharge/Recharge.blade.php ENDPATH**/ ?>