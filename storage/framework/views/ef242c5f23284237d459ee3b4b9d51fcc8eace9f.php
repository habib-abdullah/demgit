<div class="row">
    ...
    <input type="hidden" id="candidate_uid" name="candidate_uid" value="<?php echo e($row->candidate_id); ?>">
    <h3>Personal Details</h3>
        <table class="table table-striped">
            ...
            <tr><td>UPSC Prelim</td><td><?php echo e($row->upsc_prelim_attemp); ?></td></tr>
    ...
    <h3>Family & Guardian Details</h3>
        <table class="table table-striped">
            ...
            <tr><td></td><td><a target="_blank" href="<?php echo e(url('/FormPrint')); ?>/<?php echo e($row->candidate_id); ?>">Print Form</a></td></tr>
        </table>
    </div>
</div><?php /**PATH C:\xampp\htdocs\hcoi\resources\views/Admission/Details.blade.php ENDPATH**/ ?>