                    ...
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#ShiftStoreModal">Add</button>
        ...
        <div class="modal-content border-primary">
            ...
            <div class="modal-body">
                <form id="ShiftEditForm">
                    <?php echo csrf_field(); ?>
                    <input type="text" class="" id="shift_id" name="shift_id">
                    <div class="form-group">
                        <lable>Start At</lable>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/Setup/Shift.blade.php ENDPATH**/ ?>