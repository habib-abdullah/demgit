            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Purchases</div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="modal-body">
                <form id="PurchaseStoreForm">
                    ...
                    <div class="form-group">
                        <lable>Bill no</lable>
                        <input type="text" class="form-control form-control-user border-primary isrequired"
                            id="purchase_bill_no" name="purchase_no" placeholder="Enter Bill No">
                    </div>
                    <div class="form-group">
                        <lable>Description</lable>
                        <input type="text" class="form-control form-control-user border-primary isrequired"
                            id="purchase_discreption" name="purchase_discrep" placeholder="Enter Purchse Description">
                    </div>
                    <div class="form-group">
                        <lable>Quantity</lable>
                        <input type="number" class="form-control form-control-user border-primary isrequired"
                            id="purchase_quantity" name="purchase_quantity" autocomplete="off"
                            placeholder="Enter Purchse Quantity">
                    </div>
                    <div class="form-group">
                        <lable>Rate</lable>
                        <input type="number" class="form-control form-control-user border-primary isrequired"
                            id="purchase_rate" name="purchase_rate" autocomplete="off" placeholder="Enter Purchse Rate">
                    </div>
                    <div class="form-group">
                        <lable>Total Amount</lable>
                        <input type="number" class="form-control form-control-user border-primary isrequired"
                            id="purchase_amount" name="purchase_amount" autocomplete="off"
                            placeholder="Enter Purchse Amount">
                    </div>
                    <div class="form-group">
                        <lable>Order Id</lable>
                        <select class="form-control isrequired" name="order_id" id="order_id"
                            placeholder="Enter Purchse Order ID">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control isrequired" name="order_item_id" id="order_item_id">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control isrequired" name="vendor_id" id="vendor_id" style="width:100%">
                            <?php if(count($clients) > 0): ?>
                            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($client->client_id); ?>">
                                <?php echo e($client->company_name); ?></option>
...
<div class="modal fade" id="PurchaseEditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Update Purchase
</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                ...
                <form id="PurchaseUpdateForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-user border-primary edit-required"
                            id="bill_no" name="edit_no" placeholder="Enter Purchase No">
                    </div>
                    <div class="form-group">
                        <lable>Description</lable>
                        <input type="text" class="form-control form-control-user border-primary edit-required"
                            id="description" name="edit_discrep" autocomplete="off"
                            placeholde="Enter Purchase Description">
                    </div>
                    <div class="form-group">
                        <lable>Quantity</lable>
                        <input type="number" class="form-control form-control-user border-primary edit-required"
                            id="quantity" name="edit_quantity" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <lable>Rate</lable>
                        <input type="number" class="form-control form-control-user border-primary edit-required"
                            id="rate" name="edit_rate" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <lable>Total Amount</lable>
                        <input type="number" class="form-control form-control-user border-primary " id="edit_amount"
                    ...
                    <div class="form-group">
                        <lable>Vendor Id</lable>
                        <select class="form-control select2" name="edit_vendor_id" id="edit_vendor_id" style="width:100%">
                            <?php if(count($clients) > 0): ?>
                            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($client->client_id); ?>">
                                <?php echo e($client->company_name); ?></option>
        ...
        success: function(data) {
            if (data['success'] == true) {
                ...
                if (data['validation'] == false) {
                    $("#purchase_error_area").removeClass().show().html('');
                    $("#purchase_error_area").addClass("alert alert-danger").html(data['message'][0]);
                    return false;
                }
                $("#purchase_error_area").removeClass().html('').show();
                $("#purchase_error_area").addClass("alert alert-danger").html(data['message']);
                return false;
            }
        }
    })
...
function PurchaseEdit(purchase_id) {
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#bill_no').val(data[0]['purchase_bill_no'])
            $('#description').val(data[0]['purchase_description'])
            $('#quantity').val(data[0]['purchase_quantity'])
            $('#rate').val(data[0]['purchase_rate'])
            $('#tottal_amount').val(data[0]['purchase_total'])
            $('#edit_vendor_id').val(data[0]['vendor_id'])
...
function PurchaseView(purchase_id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#vendor_id_view').text(data[0]['company_name'])
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data['success'] == true) {
                ...
                if (data['validation'] == false) {
                    $("#purchase_error_update").removeClass().show().html('');
                    $("#purchase_error_update").addClass("alert alert-danger").html(data['message'][0]);
                    return false;
                }
                $("#purchase_error_update").removeClass().html('').show();
                $("#purchase_error_update").addClass("alert alert-danger").html(data['message']);
                return false;
            }
        }
    })
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchishty\resources\views/purchase/purchase.blade.php ENDPATH**/ ?>