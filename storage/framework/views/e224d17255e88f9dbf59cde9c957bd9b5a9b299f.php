                        ...
                        <form id="EmployeeStore" enctype="multipart/form-data">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab_4">
                                    <div class="form-row justify-content-center mt-5">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control required" name="entry_permit_no"
                                                ...
                                                value="<?php echo e($employee->entry_permit_no ?? ''); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" class="form-control required" name="entry_permit_date"
                                                ...
                                                value="<?php echo e($employee->entry_permit_date ?? ''); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row justify-content-center mt-2">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control required" name="emirate_id_no"
                                                ...
                                                value="<?php echo e($employee->emirate_id_no ?? ''); ?>">
                                        </div>
                                    </div>
                                    <div class="form-row justify-content-center mt-2">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" class="form-control required" name="emirate_id_expiry"
                                                ...
                                                value="<?php echo e($employee->emirate_id_expiry ?? ''); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control required" name="e_id_card_no"
                                                ...
                                                value="<?php echo e($employee->e_id_card_no ?? ''); ?>">
                                        </div>
                                    </div>
                                    <div class="form-row justify-content-center mt-2">
                                    ...
                                    <a href="Employee-<?php echo e($employee_id); ?>-Passport"
                                        class="btn btn-primary text-white float-left" style="font-size: 18px;"> Previous
                                    </a>
                                    <a href="Employee-<?php echo e($employee_id); ?>-Mol-Record" class="btn btn-warning mx-2 px-4 float-right" style="font-size: 18px;"> Skip </a>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty\resources\views/EmployeeMaster/EmployeeCreate-tab4.blade.php ENDPATH**/ ?>