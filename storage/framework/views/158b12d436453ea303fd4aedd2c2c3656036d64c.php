            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="<?php echo e(route('Employee-Document')); ?>" style="font-size: 22px;"><i
                                            ...
                                            <form id="CategoryForm">
                                                ...
                                                <div class="form-group">
                                                    <input type="text"
                                                        ...
                                                        name="cat_name" id="cat_name" autocomplete="off">
                                                </div>
                                                <!-- Modal footer -->
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/EmployeeMaster/DocumentCategory.blade.php ENDPATH**/ ?>