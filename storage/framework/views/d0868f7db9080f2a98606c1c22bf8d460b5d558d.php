        ...
        <div class="card">
          ...
          <div class="card-header d-flex p-0">
            ...
            <ul class="nav nav-pills mr-auto p-2">
              ...
              <li class="nav-item"><a class="nav-link active" href="#tab_4" data-toggle="tab">Residency details</a>
              </li>
            ...
            <form id="EmployeeStore" enctype="multipart/form-data">
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_4">
                  <div class="form-row justify-content-center mt-5">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control required" name="entry_permit_no" id="entry_permit_no"
                        placeholder="Employee entry permit no" value="<?php echo e($employee->entry_permit_no ?? ''); ?>">
                    </div>
                    <div class="form-group col-md-4">
                      <label>Entry Permit Date</label>
                      <input type="date" class="form-control required" name="entry_permit_date" id="entry_permit_date"
                        placeholder="Employee entry permit date" value="<?php echo e($employee->entry_permit_date ?? ''); ?>">
                    </div>
                  </div>
                  <div class="form-row justify-content-center mt-2">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control required" name="uid_no" id="uid_no"
                        placeholder="Employee uid no" value="<?php echo e($employee->uid_no ?? ''); ?>">
                    </div>
                    <div class="form-group col-md-4">
                      <label>File No</label>
                      <input type="text" class="form-control required" name="file_no" id="file_no"
                        placeholder="Employee file no" value="<?php echo e($employee->file_no ?? ''); ?>">
                    </div>
                  </div>
                  <div class="form-row justify-content-center mt-2">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control required" name="profession_in_residence"
                        id="profession_in_residence" placeholder="Employee profession in residence"
                        value="<?php echo e($employee->profession_in_residence ?? ''); ?>">
                    </div>
                    <div class="form-group col-md-4">
                      ...
                      <input type="date" class="form-control required" name="residence_issue_date"
                        ...
                        value="<?php echo e($employee->residence_issude_date ?? ''); ?>">
                    </div>
                  </div>
                  <div class="form-row justify-content-center mt-2">
                    <div class="form-group col-md-4">
                      ...
                      <input type="date" class="form-control required" name="residence_expiry_date"
                        id="residence_expiry_date" placeholder="Employee residence expiry date"
                        value="<?php echo e($employee->residence_expiry_date ?? ''); ?>">
                    </div>
                    <div class="form-group col-md-4">
                      <label>Emirates Id No</label>
                      <input type="text" class="form-control required" name="emirate_id_no" id="emirate_id_no"
                        placeholder="Employee emirates id no" value="<?php echo e($employee->emirate_id_no ?? ''); ?>">
                    </div>
                  </div>
                  <div class="form-row justify-content-center mt-2">
                    <div class="form-group col-md-4">
                      ...
                      <input type="date" class="form-control required" name="emirate_id_expiry" id="emirate_id_expiry"
                        placeholder="Employee emirates id expiry date" value="<?php echo e($employee->emirate_id_expiry ?? ''); ?>">
                    </div>
                    <div class="form-group col-md-4">
                      <label>E Id Card No</label>
                      <input type="text" class="form-control required" name="e_id_card_no" id="e_id_card_no"
                        placeholder="Employee E Id card no" value="<?php echo e($employee->e_id_card_no ?? ''); ?>">
                    </div>
                  </div>
                  <div class="form-row justify-content-center mt-2">
                  ...
                  <a href="Employee-<?php echo e($employee_id); ?>-Passport" class="btn btn-primary text-white float-left"
...
$(document).ready(function() {
  ...
  $("#btnSubmit").click(function(event) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo e(route('Employee-Residency-Store')); ?>",
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/EmployeeMaster/EmployeeCreate-tab4.blade.php ENDPATH**/ ?>