          ...
          <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
              <div class="card-header">
                <h3 class="card-title">
                  <a href="<?php echo e(route('Employee-Bank-Show')); ?>" style="font-size: 18px;"><i class="fas fa-arrow-circle-left"></i></a>  Add Employee Bank Detail</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="EmployeeBankStoreForm">
                ...
                <div class="form-row justify-content-center mt-3">
                <input type="hidden" class="form-control" value="<?php echo e(Session::get('employee_id')); ?>" id="emp_id" name="emp_id"> 
                <div class="form-group col-md-4">
                      ...
                      <select class="form-control" name="emp_name" id="emp_name">
                        ...
                        <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($rows->employee_id); ?>" data-project="<?php echo e($rows->employee_id); ?>"><?php echo e($rows->first_name); ?> <?php echo e($rows->last_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                </div>
                <div class="form-group col-md-4">
                  <label>Bank Name</label>
                    <input type="text" class="form-control bank_name_err"name="emp_bank_name" id="emp_bank_name" placeholder="Enter Bank Name">
                ...
                <div class="form-row justify-content-center mt-2">
                  ...
                  <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control branch_name_err" name="emp_branch_name" id="emp_branch_name" placeholder="Enter Branch Name">
                      <div class="branch_name_err_msg"></div>
                  </div>

                  <div class="form-group col-md-4">
                     <label>Account Number</label>
                     <input type="text" class="form-control acc_no_err" name="emp_ac_no" id="emp_ac_no" placeholder="Enter Account Number">
                ...
                <div class="form-row justify-content-center mt-2">
                  <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control acc_type_err" name="emp_ac_type" id="emp_ac_type" placeholder="Enter Account Type">
                      <div class="acc_type_err_msg"></div>
                  </div>

                  <div class="form-group col-md-4">
                      <label>IFSC Code</label>
                      <input type="text" class="form-control ifsc_code_err" name="emp_ifsc_code" id="emp_ifsc_code" placeholder="Enter IFSC Code">
                ...
                <div class="form-row justify-content-center mt-2">  
                  <div class="form-group col-md-4">
                      <label>IBAN</label>
                      <input type="text" class="form-control iban_no_err" name="emp_iban_no" id="emp_iban_no" placeholder="Enter IBAN no">
                  ...
                  <div class="form-group col-md-4 mt-1">
                     ...
                     name="bank_passbook_img" id="bank_passbook_img" class="bank_passbook_img_err">
                ...
                <div class="form-row justify-content-center mt-2">
                  ...
                  <span id="emp_bank_error_area" style="display: none;"class="m-auto"></span>
                    <button type="button" onclick="EmployeeBankStore()" id="emp_bank_submit" class="btn btn-primary m-auto" >Submit
                     </button>
                  </div>
                </div>
        ...
        $('#emp_name').on('change', function () 
      {
        ...
        $('#emp_profile_img').append(``);
          ...
          response.forEach(element => {
              $('#emp_profile_img').append(`<img src="<?php echo e(url('/')); ?>/public/crop_image/${element['emp_profile_img']}" alt="No image available" style="width:100px;height:auto;">`);
              });
          }
        });
    });
  ...
  //form validation code
    var bank_name_val = $("#emp_bank_name").val();
        if (bank_name_val == "")
        {
          ...
          $("#emp_bank_error_area").addClass("alert alert-danger").html("All Filed Must be required..").css({"color": "#fff"});
          return false;
        }  
        else
        {
          ...
          $("#emp_bank_error_area").removeClass("alert alert-danger").html("").css({"color": "#fff"});
        }
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Al_Chisty\resources\views/EmployeeBank/AddBankDetail.blade.php ENDPATH**/ ?>