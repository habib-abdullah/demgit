...
<div class="card card-primary">
  <div class="card-header bg-gradient-info">
    <h3>Update API Attribute</h3>
  </div>

  <form role="form" id="APIAttributeForm" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
		<input type="hidden" id="api_attr_id" name="api_attr_id" value="<?php echo e($row[0]->api_attr_id); ?>">
    <div class="row">
      <div class="col-md-12">
        <div class="card-body bg-grey">
          ...
          <div class="form-group">
            ...
            <input type="text" name="api_attr_name" class="form-control" id="api_attr_name" placeholder="Enter Name"
              value="<?php echo e($row[0]->api_attr_name); ?>">
          </div>
          <div class="form-group">
            ...
            <input type="text" name="api_attr_key" class="form-control" id="api_attr_key" placeholder="Enter key"
              value="<?php echo e($row[0]->api_attr_key); ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1"><span style="color:red; font-size:18px;">*</span>API Attribute value</label>
            <input type="text" maxlength="10" name="api_attr_value" class="form-control" id="api_attr_value"
              placeholder="Enter value" value="<?php echo e($row[0]->api_attr_value); ?>">
          </div>
          <div style="margin-bottom: 15px;">
            <button type="button" id="btnSave" class="btn btn-primary float-right"
              onclick="UpdateAPIAttribute()">Submit</button>
          </div><br>
...
function UpdateAPIAttribute() {
  ...
  $.ajax({
    type: 'POST',
    url: "<?php echo e(url('UpdateAPIAttribute')); ?>",
    data: $("#APIAttributeForm").serialize(),
    success: function(data) {
      console.log(data);
      $("#response").html(data);
      if (data.includes('API Attribute Updated')) {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PerfectRecharge\resources\views/APIs/UpdateApiAttribute.blade.php ENDPATH**/ ?>