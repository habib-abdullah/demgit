    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button onclick="MasterRevertBalance()" class="btn btn-primary">Generate</button>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PerfectRecharge\resources\views/MasterTransactionReport.blade.php ENDPATH**/ ?>