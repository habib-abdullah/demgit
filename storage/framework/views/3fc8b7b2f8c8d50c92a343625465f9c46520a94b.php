                    ...
                    <div class="tab-content col-lg-9 my-4" id="v-pills-tabContent">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <?php elseif($check < 0): ?> <strong class="text-dark">Passport Expire Date</strong>
                                        ...
                                        <?php else: ?>
                                            <strong class="text-danger">Passport Expired <?php echo e(round($date_diff, 0)); ?> Days Ago</strong>
                                ...
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php echo e(round($date_diff, 0)); ?> Days Ago
                                                ago</strong>
                                        ...
                                        <?php else: ?>
                                            <strong class="text-danger">Emirates Id Expired <?php echo e(round($date_diff2, 0)); ?> Days Ago</strong>
                                            <p class="text-danger">
                                                <?php echo e($employees->emirate_id_expiry ?? ''); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <?php elseif($check < 0): ?> <strong class="text-dark">Work Permit Expire Date</strong>
                                            ...
                                            <?php else: ?>
                                            <strong class="text-danger">Work Permit Expired <?php echo e(round($date_diff, 0)); ?> Days
                                                Ago</strong>
                        ...
                        <div class="tab-pane fade" id="v-pills-documents" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                <?php elseif($check < 0): ?> <div class="col-lg-4 col-md-4 col-sm-8">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-8">
                                <div class="card text-center"
                                    ...
                                    <div class="card-body text-uppercase">
                                        <p class="card-text text-danger my-1"> Expired <?php echo e(round($date_diff, 0)); ?> Days Ago </p>
                                        <p class="card-text my-1"><?php echo e($document->document_expiry ?? ''); ?></p>
                                        <p class="card-text my-1"><?php echo e($document->document_name ?? ''); ?></p>
                                    </div>
                                    <div class="card-footer" style="height:40px;">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchishty\resources\views/EmployeeMaster/EmployeeDetails.blade.php ENDPATH**/ ?>