        ...
        <div class="col-md-12 mb-2">
            <div class="card">
              ...
              alt="User profile picture"> -->
                  ...
                  <?php echo e($clients[0]->company_address); ?>
                ...
                <tr>
                  ...
                  <th>Popularity</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        <!-- <td><input type="text" name="<?php echo e($document->document_id); ?>"></td> -->
                                            <td class="text-bold">
                                            ...
                                            <td><Button type="button" class="btn btn-danger"
                                                    onclick="DocumentRemove()">Delete</Button></td>
        ...
        <div class="modal-content border-primary">
            ...
            <div class="modal-body">
                <form id="BankEditForm">
                    <?php echo csrf_field(); ?>
                    <input type="text" id="banks_id" name="banks_id">
                    <div class="form-group">
                        <label>Bank Name</label>
...
function DocumentRemove(document_id) {
    var url_edit = base_url + "/Admin/ClientDocument-" + document_id + "-Remove";
    swal({
        title: "Are you sure?",
        text: "Once deleted, you will not be able to recover this record!",
        icon: "warning",
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/Client/ClientProfile.blade.php ENDPATH**/ ?>