                                ...
                                <div class="tab-pane active" id="tab_7">
                                    <div class="form-row justify-content-center mt-5">
                                        <div class="form-group col-md-4">
                                            <label>Contact</label>
                                            <input type="number" class="form-control contact_required" name="employee_contact"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" class="form-control contact_required"
                                                ...
                                                value="<?php echo e($employee->whatsapp_no ?? ''); ?>">
                                        </div>
                                    </div>
                                    <div class="form-row justify-content-center mt-2">
                                        <div class="form-group col-md-4">
                                            <label>IMO No</label>
                                            <input type="text" class="form-control contact_required" name="employee_imo_no"
                                                id="employee_imo_no" placeholder="Employee imo no"
                                                value="<?php echo e($employee->imo_no ?? ''); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label>Facebook</label>
                                            <input type="text" class="form-control contact_required" name="employee_facebook"
                                                id="employee_facebook" placeholder="Employee facebook"
                                                value="<?php echo e($employee->facebook ?? ''); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row justify-content-center mt-2">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control required"
                                                ...
                                                value="<?php echo e($employee->permanent_contact_name ?? ''); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" class="form-control required"
                                                ...
                                                value="<?php echo e($employee->permanent_contact_no ?? ''); ?>">
                                        </div>
                                    </div>
                                    <div class="form-row justify-content-center mt-2">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control required"
                                                ...
                                                value="<?php echo e($employee->permanent_contact_relation ?? ''); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                        </div>
                                    </div>
                                    <div class="form-row justify-content-center mt-2">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control required"
                                                ...
                                                value="<?php echo e($employee->uae_emergency_contact_name ?? ''); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" class="form-control required"
                                                ...
                                                value="<?php echo e($employee->uae_emergency_contact_no ?? ''); ?>">
                                        </div>
                                    </div>
                                    <div class="form-row justify-content-center mt-2">
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="text" class="form-control required"
                                                ...
                                                value="<?php echo e($employee->uae_emergency_contact_address ?? ''); ?>">
                                        </div>
                                    </div>-->
                                    <div class="form-row justify-content-center mt-2">
                                    ...
                                    <a href="Employee-<?php echo e($employee_id); ?>-Health"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="AdditionalInfoForm">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" id="employee_id" name="employee_id" value="<?php echo e($employee_id); ?>">
            ...
            <span id="show_error" style="display: none; margin:0px 20px; text-align:center;"></span>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" onclick="AdditionalIInfoInsert()">Save</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="EditInfoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="AdditionalInfoEditForm">
                    ...
                    <div class="form-group">
                        <lable>Contact Relation</lable>
                        <input type="text" class="form-control form-control-user border-primary info_edit_input"
                            id="edit_relation" name="edit_relation" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <lable>Contact Number</lable>
                        <input type="number" class="form-control form-control-user border-primary info_edit_input"
                            id="edit_number" name="edit_number" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <lable>Contact Address</lable>
                        <input type="text" class="form-control form-control-user border-primary info_edit_input"
            ...
            <span id="show_edit_error" style="display: none; margin:0px 20px; text-align:center;"></span>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data['success'] == true) {
                    ...
                    $("#contact_show_error").removeClass().show().html('');
                    $("#contact_show_error").addClass("alert alert-danger").html(data['message'][0]);
                    return false;
                }
                    $("#contact_show_error").removeClass().show().html('');
                    $("#contact_show_error").addClass("alert alert-danger").html(data['message']);
                }
            }
        });
    });
...
$(function() {
    ...
    var tables = $("#DataTable").DataTable({
        ...
        "serverSide": true,
        ajax: {
            url: "<?php echo e(route('Addtional-Info-Show')); ?>",
            data: {
                employee_id: "<?php echo e($employee_id); ?>"
            },
        },
        columns: [{
                data: 'contact_id',
...
function AdditionalIInfoInsert() {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(route('Additionalinfo-Store')); ?>",
...
function AdditionalIInfoUpdate() {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(route('AdditionalInfo-Update')); ?>",
...
function AdditionalInfoRemove(contact_id) {
    swal({
        ...
        if (willDelete) {
            $.get("<?php echo e(route('AdditionalInfo-Remove')); ?>", {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/EmployeeMaster/EmployeeCreate-tab7.blade.php ENDPATH**/ ?>