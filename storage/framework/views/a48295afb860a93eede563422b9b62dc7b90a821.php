          ...
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto">
              <button type="button" class="btn btn-primary px-4" data-toggle="modal"
                data-target="#logStoreModal">Add</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <form id="LogStoreForm" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-user border-primary required" id="visitor_name"
              name="visitor_name" autocomplete="off">
          </div>
          <div class="form-group">
            ...
            <input type="number" class="form-control form-control-user border-primary required" id="visitor_mobile"
              name="visitor_mobile" autocomplete="off">
          </div>
          <div class="form-group">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty-main\resources\views/Visitor/Visitor.blade.php ENDPATH**/ ?>