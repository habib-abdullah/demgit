                        ...
                        <form id="EmployeeStore" enctype="multipart/form-data">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab_5">
                                    <div class="form-row justify-content-center mt-5">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control required" name="work_permit_no"
                                                ...
                                                value="<?php echo e($employee->work_permit_no ?? ''); ?>">
                                            <div class=""></div>
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control required" name="personal_no"
                                                ...
                                                value="<?php echo e($employee->personal_no ?? ''); ?>">
                                            <div class=""></div>
                                        </div>
                                    </div>
                                    <div class="form-row justify-content-center mt-2">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" class="form-control required" name="work_permit_expiry"
                                                ...
                                                value="<?php echo e($employee->work_permit_expiry ?? ''); ?>">
                                            <div class=""></div>
                                        </div>
                                        <div class="form-group col-md-4">
                                        </div>
                                    ...
                                    <a href="Employee-<?php echo e($employee_id); ?>-Residency"
                                        class="btn btn-primary text-white float-left" style="font-size: 18px;"> Previous
                                    </a>
                                    <a href="Employee-<?php echo e($employee_id); ?>-Health" class="btn btn-warning mx-2 px-4 float-right" style="font-size: 18px;"> Skip </a>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alchisty\resources\views/EmployeeMaster/EmployeeCreate-tab5.blade.php ENDPATH**/ ?>