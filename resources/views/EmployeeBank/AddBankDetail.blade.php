      ...
      <div class="col-md-12">
        ...
        <div class="card card-outline card-primary">
          <div class="card-header">
            <h3 class="card-title">
              <a href="{{route('Employee-Bank-Show')}}" style="font-size: 18px;"><i
          ...
          <form id="EmployeeBankStoreForm">
            ...
            <div class="form-row justify-content-center mt-3">
              <input type="hidden" class="form-control" value="{{Session::get('employee_id')}}" id="emp_id"
                name="emp_id">
              <div class="form-group col-md-4">
                ...
                <select class="form-control" name="emp_name" id="emp_name">
                  ...
                  @foreach($row as $rows)
                  <option value="{{$rows->employee_id}}" data-project="{{ $rows->employee_id }}">{{$rows->first_name}}
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        response.forEach(element => {
          $('#emp_profile_img').append(
            `<img src="{{url('/')}}/public/crop_image/${element['emp_profile_img']}" alt="No image available" style="width:100px;height:auto;">`
          );
        });
      }
    });
