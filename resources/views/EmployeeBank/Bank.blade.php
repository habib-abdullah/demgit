      ...
      <div class="card shadow" style="border-left: 2px solid #007BFF; ">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto">
              <a href="{{route('Employee-Bank-Create')}}"><button type="button" class="btn btn-primary">Add</button></a>
            </div>
    ...
    columns: [{
      ...
      },
      {
        ...
        render: function(data) {
          ...
          return '<img src="{{url("public/Employee/Bank_Pasbook_Images")}}/' + data +
