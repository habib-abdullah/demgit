...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand  bg-gradient-primary navbar-dark navbar">
          ...
          <a href="{{url('MasterBalanceTransfer')}}" class="nav-link">Balance Transfer</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{url('Admin/Dashboard')}}" class="brand-link text-center">
                <!-- <img src="{{asset('public/dist/img/AdminLTELogo.png')}}" class="brand-image img-circle elevation-3"
                    style="opacity: .8"> -->
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item main_active ">
                            <a href="{{url('Admin/CompanySite')}}" class="nav-link {{ (request()->segment(2) == 'CompanySite') ? 'active' : '' }}">
                        ...
                        <?php endif; ?>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item main_active ">
                                    <a href="{{route('UOM')}}" class="nav-link {{ (request()->segment(2) == 'UOM') ? 'active' : '' }}">
                                        <i class="nav-icon fas fa-glass-martini-alt"></i>
                                        <p>UOM</p>
                                    </a>
                                </li>
                                <li class="nav-item main_active ">
                                    <a href="{{route('Operation')}}" class="nav-link {{ (request()->segment(2) == 'Operation') ? 'active' : '' }}">
                                        <i class="nav-icon fas fa-tasks"></i>
                                        <p>Operation</p>
                                    </a>
                                </li>
                                <li class="nav-item main_active ">
                                    <a href="{{route('Department')}}" class="nav-link {{ (request()->segment(2) == 'Department') ? 'active' : '' }}">
                                        <i class="nav-icon fas fa-building"></i>
                                        <p>Department</p>
                                    </a>
                                </li>
                                <li class="nav-item main_active ">
                                    <a href="{{route('Machine')}}" class="nav-link {{ (request()->segment(2) == 'Machine') ? 'active' : '' }}">
                                        <i class="nav-icon fas fa-industry"></i>
                                        <p>Machine</p>
                                    </a>
                                </li>
                                <li class="nav-item main_active ">
                                    <a href="{{route('Shift')}}" class="nav-link {{ (request()->segment(2) == 'Shift') ? 'active' : '' }}">
                        ...
                        <?php endif; ?>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item main_active ">
                                    <a href="{{route('Items-Grades')}}" class="nav-link {{ (request()->segment(2) == 'Items-Grades') ? 'active' : '' }}">
                                        <i class="nav-icon fas fa-circle"></i>
                                        <p>Items Grades</p>
                                    </a>
                                </li>
                                <li class="nav-item main_active ">
                                    <a href="{{route('Items-Sizes')}}" class="nav-link {{ (request()->segment(2) == 'Items-Sizes') ? 'active' : '' }}">
                                        <i class="nav-icon fas fa-circle"></i>
                                        <p>Item Sizes</p>
                                    </a>
                                </li>
                                <li class="nav-item main_active ">
                                    <a href="{{route('Items')}}" class="nav-link {{ (request()->segment(2) == 'Items') ? 'active' : '' }}">
                                        <i class="nav-icon fas fa-circle"></i>
                                        <p>Items</p>
                                    </a>
                                </li>
                        ...
                        <?php endif; ?>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item main_active ">
                                    <a href="{{route('Employe-Master-Show')}}" class="nav-link {{ (request()->segment(2) == 'EmployeMaster') ? 'active' : '' }}">
                                        <i class="nav-icon fas fa-user"></i>
                                        <p>Employee</p>
                                    </a>
                                </li>
                                <!-- <li class="nav-item main_active ">
                                <a href="{{route('Employee-Bank-Show')}}" class="nav-link">
                                    <i class="nav-icon fas fa-university"></i>
                                    <p>Employee Bank</p>
                                </a>
                                </li>
                                <li class="nav-item main_active ">
                                <a href="{{route('Employee-Contact-Detail-Show')}}" class="nav-link">
                                    <i class="nav-icon fas fa-address-book"></i>
                                    <p>Contact</p>
                                </a>
                                </li> -->
                                <li class="nav-item main_active ">
                                    <a href="{{route('Employee-Shifts')}}" class="nav-link {{ (request()->segment(2) == 'Employee-Shifts') ? 'active' : '' }}">
                                        <i class="nav-icon fas fa-circle"></i>
                                        <p>Shifts</p>
                                    </a>
                                </li>
                                <!-- <li class="nav-item main_active ">
                                    <a href="{{route('Employee-Document')}}" class="nav-link">
                                        <i class="nav-icon fas fa-address-book"></i>
                                        <p>Documents</p>
                                    </a>
                                </li> -->
                        ...
                        <li class="nav-item main_active ">
                            <a href="{{route('Visitor-Log')}}" class="nav-link {{ (request()->segment(2) == 'Visitor-Log') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-chalkboard-teacher"></i>
                                <p>Client Logs</p>
                            </a>
                        </li>
                        <li class="nav-item main_active ">
                            <a href="{{route('Client')}}" class="nav-link {{ (request()->segment(2) == 'Client') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-user"></i>
                                <p>Clients</p>
                            </a>
                        </li>
                        <li class="nav-item main_active ">
                            <a href="{{route('Purchase')}}" class="nav-link {{ (request()->segment(2) == 'Purchase') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-shopping-cart"></i>
                                <p>Purchase</p>
                            </a>
                        </li>
                        <li class="nav-item main_active ">
                            <a href="{{route('Sales-Inquiry')}}" class="nav-link {{ (request()->segment(2) == 'Sales-Inquiry') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-home"></i>
                                <p>Pre Sales Inquiry</p>
                            </a>
                        </li>
                        <li class="nav-item main_active ">
                            <a href="{{route('Sales-Order')}}" class="nav-link {{ (request()->segment(2) == 'Sales-Order') ? 'active' : '' }}">
