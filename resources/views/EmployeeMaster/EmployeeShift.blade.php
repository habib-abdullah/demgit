            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <!-- <a href="{{route('Designation-Create')}}"><button type="button" class="btn btn-primary"
                  data-toggle="modal" data-target="#myModal">Designation</button></a> -->
                            <a href="{{url('Employee-Shift-Create')}}"><button type="button" class="btn btn-primary">Add
                                    Shift</button></a>
                        </div>
                    </div>
                </div>
...
$(function() {
    var tables = $("#DataTable").DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{route('Employee-Shift-Show')}}",
        columnDefs: [{
            orderable: false,
        ...
        columns: [{
                ...
                render: function(data) {
                    if (data != null) {
                        return '<img src="{{url("public/crop_image/")}}/' + data +
                            '" style="width:70px;height:auto;">';
                    } else {
                        return '<img src="{{url("public/crop_image/default.jpg")}}" style="width:70px;height:auto;">';
                    }
                },
                "seachable": false,
                "orderable": false,
