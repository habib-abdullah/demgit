            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <!-- <a href="{{route('Employee-Document')}}" style="font-size: 18px;"><i
...
$(function() {
    ...
    buttons: [
      ...
      },
      {
        ...
        processing: true,
        serverSide: true,
        ajax: "{{route('Document-Category-Show')}}",
        columns: [{
                data: 'category_id',
                "orderable": true,
                "searchable": false,
...
$('#submit').click(function() {
    ...
    $.ajax({
        ...
        type: "POST",
        url: "{{route('Document-Category-Store')}}",
...
function DocumentCategoryRemove(category_id) {
    swal({
        ...
        if (willDelete) {
            $.get("{{route('Document-Category-Remove')}}", {
