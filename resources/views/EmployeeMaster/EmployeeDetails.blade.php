          ...
          <h3 class="h3 profile-username text-bold"> Personal Info</h3>
                ...
                <div class="text-center mt-4">
                    <img class="profile-user-img img-fluid img-circle"
                        src="{{url('/')}}/public/Employee/{{$emp_profile_img ?? 'default.jpg'}}"
                        alt="User profile picture">
                </div>
                <h3 class="profile-username text-center text-capitalize">{{$employees->first_name ?? ''}}
                    {{$employees->last_name ?? ''}}</h3>
                <p class="text-muted text-center text-capitalize">{{$employees->designation ?? ''}}</p>
                <div class="row">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class=" text-capitalize" style="list-style:none;">
                                    <b>Marital Status</b> <a
                                        class="float-right">{{$employees->marital_status ?? ''}}</a>
                                    <hr>
                                </li>
                                <li class=" text-capitalize" style="list-style:none;">
                                    <b>VISA Issued From</b> <a
                                        class="float-right">{{$employees->visa_Issued_from ?? ''}}</a>
                                    <hr>
                                </li>
                                <li class=" text-capitalize" style="list-style:none;">
            ...
            <div class="card">
                ...
                <div class="card-header d-flex p-0">
                    <div class="nav flex-column nav-pills col-lg-3 my-4" id="v-pills-tab" role="tablist"
                        ...
                        <a class="nav-link  mx-4" id="v-pills-additional-contact-tab" data-toggle="pill"
                            href="#v-pills-additional-contact" role="tab" aria-controls="v-pills-additional-contact"
                            aria-selected="false">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">{{$employees->passport_issue_date ?? ''}}</p>
                                        ...
                                        <?php
                                            ...
                                            $expire_date = strtotime($employees->passport_expiry_date.' 00:37:15');
                                         ...
                                         ?>
                                        @if($check == 0)
                                        <strong class="text-warning">Passport Expire Today</strong>

                                        <p class="text-warning">
                                            {{$employees->passport_expiry_date ?? ''}}
                                        </p>
                                        @elseif($check < 0) <strong class="text-dark">Passport Expire Date</strong>

                                            <p class="text-muted">
                                                {{$employees->passport_expiry_date ?? ''}}
                                            </p>
                                        @else
                                            <strong class="text-danger">Passport Expired {{round($date_diff, 0)}} Days Ago</strong>
                                        ...
                                        @endif
                                            ...
                                            <p class="text-muted">
                                                {{$employees->passport_issue_place ?? ''}}
                                            </p>
                                            ...
                                            <p class="text-muted">
                                                {{$employees->permanent_add_in_passport ?? ''}}
                                            </p>
                                            <hr>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">
                                            {{$employees->pp_personal_no ?? ''}}
                                        </p>
                                        <hr>
                                        <strong>NIC Card No</strong>

                                        <p class="text-muted">
                                            {{$employees->nic_card_no ?? ''}}
                                        </p>
                                        <hr>
                                        <strong>NIC Expiry</strong>

                                        <p class="text-muted">
                                            {{$employees->nic_expiry ?? ''}}
                                        </p>
                                        <hr>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">{{$employees->entry_permit_date ?? ''}}</p>
                                        ...
                                        <p class="text-muted">
                                            {{$employees->profession_in_residence ?? ''}}
                                        </p>
                                        <hr>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">
                                            {{$employees->residence_issude_date ?? ''}}
                                        </p>
                                        <hr>
                                        <?php
                                            date_default_timezone_set('Asia/Calcutta');
                                            ...
                                            $date_today = $datetime->format('Y-m-d');
                                            $date_now = strtotime($date_today.' 00:37:15'); // or your date as well
                                            $expire_date = strtotime($employees->residence_expiry_date.' 00:37:15');
                                            $datediff = $date_now - $expire_date;
                                            $date_diff = $datediff / 86400;
                                            // $date_diff = $datediff / (60 * 60 * 24);
                                             $check =  round($date_diff, 0);
                                         ?>
                                        @if($check == 0)
                                        <strong class="text-warning">Residence Expire Today</strong>

                                        <p class="text-warning">
                                            {{$employees->residence_expiry_date ?? ''}}
                                        </p>
                                        @elseif($check < 0)
                                        <strong class="text-dark">Residence Expire Date</strong>

                                            <p class="text-muted">
                                                {{$employees->	residence_expiry_date ?? ''}}
                                            </p>
                                        @else
                                            <strong class="text-danger">Residence Expired 
                                            {{round($date_diff, 0)}} Days Ago
                                                ago</strong>
                                        ...
                                        @endif
                                            ...
                                            <p class="text-muted">
                                                {{$employees->emirate_id_no ?? ''}}
                                            </p>
                                            <hr>
                                        <?php
                                            date_default_timezone_set('Asia/Calcutta');
                                            $datetime2 = new DateTime();
                                            $date_today2 = $datetime2->format('Y-m-d');
                                            $date_now2 = strtotime($date_today2.' 00:37:15'); // or your date as well
                                            $expire_date2 = strtotime($employees->emirate_id_expiry.' 00:37:15');
                                            $datediff2 = $date_now2 - $expire_date2;
                                            $date_diff2 = $datediff2 / 86400;
                                             $check2 =  round($date_diff2, 0);
                                         ?>
                                        @if($check2 == 0)
                                            <strong class="text-warning">Emirates Id Expiry Today</strong>
                                            <p class="text-warning">
                                                {{$employees->emirate_id_expiry ?? ''}}
                                            </p>
                                        @elseif($check2 < 0)
                                        ...
                                        @else
                                            <strong class="text-danger">Emirates Id Expired {{round($date_diff2, 0)}} Days Ago</strong>
                                            <p class="text-danger">
                                                {{$employees->emirate_id_expiry ?? ''}}
                                            </p>
                                        @endif
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">{{$employees->contact ?? ''}}</p>
                            ...
                            <!-- <div class="row">
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">{{$banks[0]->branch_name ?? ""}}</p>
                                        <hr>

                                        <strong> Account Type</strong>

                                        <p class="text-muted">
                                            {{$banks[0]->account_type ?? ""}}
                                        </p>
                                        <hr>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">
                                            {{$employees->work_permit_no ?? ''}}
                                        </p>
                                        <hr>

                                        <strong> Personal No</strong>
                                        <p class="text-muted">{{$banks[0]->account_name ?? ""}}</p>
                                        <hr>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        <?php
                                            ...
                                            $date_today = $datetime->format('Y-m-d');
                                            $date_now = strtotime($date_today.' 00:37:15'); // or your date as well
                                            $expire_date = strtotime($employees->	work_permit_expiry.' 00:37:15');
                                            $datediff = $date_now - $expire_date;
                                            $date_diff = $datediff / 86400;
                                            // $date_diff = $datediff / (60 * 60 * 24);
                                             $check =  round($date_diff, 0);
                                         ?>
                                        @if($check == 0)
                                        <strong class="text-warning">Work Permit Expire Today</strong>

                                        <p class="text-warning">
                                            {{$employees->work_permit_expiry ?? ''}}
                                        </p>
                                        @elseif($check < 0) <strong class="text-dark">Work Permit Expire Date</strong>

                                            <p class="text-muted">
                                                {{$employees->	work_permit_expiry ?? ''}}
                                            </p>
                                            @else
                                            <strong class="text-danger">Work Permit Expired {{round($date_diff, 0)}} Days
                                                Ago</strong>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">
                                            {{($employees->height != '') ? str_replace("_"," ",$employees->height)  : ''}}
                                        </p>
                                        <hr>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">
                                            {{ $employees->status == 1? 'In Service' : 'Resigned' }}
                                        </p>
                                        <hr>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-documents" role="tabpanel"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-8">
                                    <div class="card white text-center"
                                        ...
                                        <div class="card-header bg-warning text-white text-uppercase "
                                            style="height:40px;">
                                            <h5 class="card-text ">{{$document->document_category ?? ''}}</h5>
                                        </div>
                                        <div class="card-body text-uppercase">
                                            <p class="card-text text-warning my-1"> Expire Today </p>
                                            <p class="card-text my-1">{{$document->document_expiry ?? ''}}</p>
                                            <p class="card-text my-1">{{$document->document_name ?? ''}}</p>
                                        </div>
                                        <div class="card-footer" style="height:40px;">
                                            <a class="btn btn-warning btn-sm mt-0" style="margin-top:-6px !important;"
                                                href="{{url('/')}}/public/Employee/{{$document->attachment ?? '' }}"
                                                target="_blank"> <i class="fa fa-download"
                                                    style="font-size:14px !important;"></i> </a>
                                        </div>
                                    </div>
                                </div>
                                @elseif($check < 0) <div class="col-lg-4 col-md-4 col-sm-8">
                                    <div class="card text-center"
                                        ...
                                        <div class="card-body text-uppercase">
                                            <!-- <p class="card-text text-dark my-1"> Expire Date </p> -->
                                            <p class="card-text my-1">{{$document->document_expiry ?? ''}}</p>
                                            <p class="card-text my-1">{{$document->document_name ?? ''}}</p>
                                        </div>
                                        <div class="card-footer" style="height:40px;">
                                            <a class="btn btn-dark btn-sm mt-0" style="margin-top:-6px !important;"
                                                href="{{url('/')}}/public/Employee/{{$document->attachment ?? '' }}"
                                                target="_blank"> <i class="fa fa-download"
                                                    style="font-size:14px !important;"></i> </a>
                                        </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-8">
                                <div class="card text-center"
                                    ...
                                    <div class="card-body text-uppercase">
                                        <p class="card-text text-danger my-1"> Expired {{round($date_diff, 0)}} Days Ago </p>
                                        <p class="card-text my-1">{{$document->document_expiry ?? ''}}</p>
                                        <p class="card-text my-1">{{$document->document_name ?? ''}}</p>
                                    </div>
                                    <div class="card-footer" style="height:40px;">
                                        <a class="btn btn-danger btn-sm mt-0" style="margin-top:-10px !important;"
                                            href="{{url('/')}}/public/Employee/{{$document->attachment ?? '' }}"
                                            target="_blank"> <i class="fa fa-download"
                                                style="font-size:14px !important;"></i> </a>
                                    </div>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane " id="tab_3">
              <div class="card-body">
                ...
                <p class="text-muted">
                  {{$employees->permanent_contact_name ?? ''}}
                </p>
                <hr>
                <strong> Permanent Contact Number</strong>

                <p class="text-muted">
                  {{$employees->permanent_contact_no ?? ''}}
                </p>
                <hr>
                <strong> Permanent Contact Relation</strong>

                <p class="text-muted">
                  {{$employees->permanent_contact_relation ?? ''}}
                </p>
                <hr>
                <strong> UAE Emergency Contact Name</strong>

                <p class="text-muted">
                  {{$employees->uae_emergency_contact_name ?? ''}}
                </p>
                <hr>
                <strong> UAE Emergency Contact No.</strong>

                <p class="text-muted">
                  {{$employees->uae_emergency_contact_no ?? ''}}
                </p>
                <hr>
                ...
                <p class="text-muted">
                  {{$employees->uae_emergency_contact_address ?? ''}}
                </p>
              </div>
            </div>
