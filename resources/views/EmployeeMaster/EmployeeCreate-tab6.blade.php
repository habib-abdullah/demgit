                                ...
                                <div class="tab-pane active" id="tab_6">
                                    <div class="form-row justify-content-center mt-5">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            placeholder="Employee height" value="{{$employee->height ?? ''}}"> -->
                                            <div class=""></div>
                                    ...
                                    <div class="form-row justify-content-center mt-2">
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="text" class="form-control required" name="medical_issues"
                                                ...
                                                value="{{$employee->medical_issues ?? ''}}">
                                            <div class=""></div>
                                        </div>
                                    </div>
                                    <!-- <input type="text" name="height" value="{{$employee->height ?? ''}}"> -->
                                    <div class="form-row justify-content-center mt-2">
                                        <div class="form-group" id="show_error">
                                        </div>
                                    </div>
                                    <a href="Employee-{{$employee_id}}-Mol-Record"
                                        class="btn btn-primary text-white float-left" style="font-size: 18px;"> Previous
                                    </a>
                                    <a href="Employee-{{$employee_id}}-Contact" class="btn btn-warning mx-2 px-4 float-right" style="font-size: 18px;"> Skip </a>
...
$(document).ready(function() {
    ...
    $("#employee_height option").each(function() {
        ...
        if ($(this).val() == "{{$employee->height}}") {
            $("#employee_height option[value={{$employee->height}}]").attr('selected', 'selected');
        }
    });
    ...
    $("#btnSubmit").click(function(event) {
        ...
        $.ajax({
            type: "POST",
            url: "{{route('Employee-Health-Store')}}",
