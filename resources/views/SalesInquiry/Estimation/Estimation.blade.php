        ...
        <div class="col-md-12 mb-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <a href="{{route('Sales-Inquiry')}}" style="font-size: 18px;"><i class="fas fa-arrow-circle-left"></i>
                            Back </a>
                    </h3>
                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class=" text-capitalize" style="list-style:none;">
                                    ...
                                    <a class="float-right">{{$inquiry[0]->inquiry_date}}</a>
                                    <hr>
                                </li>
                                <li class=" text-capitalize" style="list-style:none;">
                                    <b>Assignee</b> <a class="float-right">{{$inquiry[0]->first_name}}
                                        {{$inquiry[0]->last_name }}</a>
                                    <hr>
                                </li>
                                <li class=" text-capitalize" style="list-style:none;">
                                    <b>Inquiry Channel</b> <a class="float-right">{{$inquiry[0]->inquiry_channel}}</a>
                                    <hr>
                                </li>
                                <li class=" text-capitalize" style="list-style:none;">
                                    <b>Email</b> <a class="float-right">{{$inquiry[0]->inquiry_person_email}}</a>
                                    <hr>
                                </li>
                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="" style="list-style:none;">
                                    <b>Customer</b> <a class="float-right">{{$inquiry[0]->company_name}}</a>
                                    <hr>
                                </li>
                                <li class="" style="list-style:none;">
                                    <b>Inquiry Response Deadline</b> <a
                                        class="float-right">{{$inquiry[0]->inquiry_response_date}}</a>
                                    <hr>
                                </li>
                                <li class="" style="list-style:none;">
                                    <b>Inquiry Subject</b> <a class="float-right">{{$inquiry[0]->inquiry_subject}}</a>
                                    <hr>
                                </li>
                                <li class="" style="list-style:none;">
...
$(document).ready(function() {
    ...
    $.get("{{Route('Estimation-Item-Show')}}", { inquiry_id : "{{$inquiry_id}}" }, function(data){
        console.log(data);
    });
    ...
    var table = $("#Table").DataTable({
        ...
        "serverSide": true,
        ajax: {
            url: "{{Route('Estimation-Item-Show')}}",
