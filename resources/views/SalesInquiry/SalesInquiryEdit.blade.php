        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form id="SalesInquiryEditForm">
                    @csrf
                    <input type="hidden" id="inquiry_id" name="inquiry_id" value="{{$sales[0]->inquiry_id}}">
                    <div class="form-row justify-content-center mt-5">
                        <div class="form-group col-md-4">
                            ...
                            <input type="datetime-local" class="form-control inquirey_required" name="inquiry_date"
                                id="edit_edit_inquiry_date" value="{{$sales[0]->inquiry_date}}"
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="datetime-local" class="form-control inquirey_required"
                                ...
                                value="{{$sales[0]->inquiry_response_date}}"
                    ...
                    <div class="form-row justify-content-center mt-3">
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control selectBox Customer" name="client_id" id="client_id">
                                ...
                                @if($sales[0]->client_id == $row->client_id)
                                <option selected value="{{$row->client_id}}">
                                    {{$row->company_name}}
                                </option>
                                @else
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control selectBox Customer" name="employee_id" id="employee_id">
                                ...
                                @if($sales[0]->employee_id == $employee->employee_id)
                                <option selected value="{{$employee->employee_id}}">
                    ...
                    <div class="form-row justify-content-center mt-3">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control inquirey_required" name="inquiry_person"
                                id="inquiry_person" value="{{$sales[0]->inquiry_person}}"
                                placeholder="Enter Contact Person">
                        </div>
                        <div class="form-group col-md-4">
                            <label>Contact Person Number</label>
                            <input type="number" class="form-control inquirey_required" name="inquiry_person_mobile"
                                id="inquiry_person_mobile" value="{{$sales[0]->inquiry_person_mobile}}"
                    ...
                    <div class="form-row justify-content-center mt-3">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control inquirey_required " name="inquiry_person_email"
                                id="inquiry_person_email" value="{{$sales[0]->inquiry_person_email}}"
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control inquirey_required" name="inquiry_channel"
                                id="inquiry_channel" value="{{$sales[0]->inquiry_channel}}"
                    ...
                    <div class="form-row justify-content-center mt-3">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control inquirey_required" name="inquiry_no" id="inquiry_no"
                                value="{{$sales[0]->inquiry_no}}" placeholder="Enter Inquiry No">
                        </div>
                        <div class="form-group col-md-4">
                            <label>Inquiry Subject</label>
                            <input type="text" class="form-control inquirey_required" name="inquiry_subject"
                                id="inquiry_subject" value="{{$sales[0]->inquiry_subject}}"
                    ...
                    <div class="form-row justify-content-center mt-3">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control inquirey_required" name="inquiry_note"
                                id="inquiry_note" value="{{$sales[0]->inquiry_note}}" placeholder="Enter inquiry Note">
                        </div>
...
$(function() {
    ...
    var tables = $("#Table").DataTable({
        ...
        "serverSide": true,
        ajax: {
            url: "{{route('SalesInquiryItem-Show')}}",
            data: {
...
function SalesInquiryStore() {
    ...
    $.ajax({
        type: "POST",
        url: "{{route('SalesInquiryItem-Store')}}",
        data: formData,
        contentType: false,
        processData: false,
        error: function(jqXHR, textStatus, errorThrown) {
...
function SalesInquiryItemEdit(item_id) {
    $.ajax({
        type: "GET",
        url: "{{route('SalesInquiryItem-Edit')}}",
        data: {
            item_id: item_id
        },
        success: function(data) {
...
function SalesInquiryItemView(item_id) {
    $.ajax({
        type: "GET",
        url: "{{route('SalesInquiryItem-View')}}",
        data: {
            item_id: item_id
        },
        success: function(data) {
...
function documentRemove(attachment_id) {
    swal({
        ...
        if (willDelete) {
            $.get("{{route('SalesInquiryItemDocument-Remove')}}", {
...
function SalesInquiryUpdate() {
    ...
    $.ajax({
        type: "POST",
        url: "{{route('SalesInquiryItem-Update')}}",
        data: formData,
        contentType: false,
        processData: false,
        error: function(jqXHR, textStatus, errorThrown) {
...
function SalesInquiryItemRemove(item_id) {
    swal({
        ...
        if (willDelete) {
            $.get("{{route('SalesInquiryItem-Remove')}}", {
                item_id: item_id
            }, function(data) {
