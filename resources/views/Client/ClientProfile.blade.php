        ...
        <div class="col-md-12 mb-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <a href="{{route('Client')}}" style="font-size: 18px;"><i class="fas fa-arrow-circle-left"></i>
                            Back </a>
                    </h3>
                    <h3 class="h3 text-center text-bold text-uppercase"> {{$clients[0]->company_name}}</h3>
                    <h3 class="h5 text-center text-capitalize"> {{$clients[0]->company_address}}</h3>
                </div>
                <div class="row">
                    <div class="col-md-6">
                                ...
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> : {{$clients[0]->client_name ?? ""}}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-bold">
                                                <p href="javascript:void(0)">Company Name</p>
                                            </td>
                                            <td class="text-capitalize"> : {{$clients[0]->company_name ?? ""}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> : {{$clients[0]->client_code ?? ""}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> : {{$clients[0]->company_phone ?? ""}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> : {{$clients[0]->company_mobile ?? ""}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> : {{$clients[0]->company_address ?? ""}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> :
                                                {{$clients[0]->trade_license_register_authority ?? ""}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> : {{$clients[0]->trade_license_number ?? ""}}
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> : {{$clients[0]->trn_number ?? ""}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> :
                                                {{$clients[0]->trade_license_issue_date ?? ""}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> :
                                                {{$clients[0]->trade_license_expiry_date ?? ""}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-capitalize">: {{$clients[0]->credit_duration ?? ""}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> : {{$clients[0]->balance_limit ?? ""}}</td>
                            ...
                            <div class="table-responsive">
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-bold">
                                                <p href="javascript:void(0)">{{$document->document_name}} </p>
                                            </td>
                                            <!-- <td class="">
                                                :
                                            </td> -->
                                            <td> : <a target="_blank"
                                                    href="{{url('/public/Client/ClientDocuments/')}}/{{$document->document_file}}">{{$document->document_file}}</a>
                                            </td>
                                            <td><Button type="button" id="" class="btnRemove btn btn-danger"
                                                    value="{{$document->document_id}}"><i
        ...
        <div class="modal-content border-primary">
            ...
            <div class="modal-body">
                <form id="ContactStoreForm">
                    @csrf
                    <input type="hidden" value="{{$clients[0]->client_id}}" id="client_id" name="client_id">
...
function ContactUpdate() {
    ...
    $.ajax({
        type: "POST",
        url: "{{route('Client-Contact-Update')}}",
...
function ClientContactRemove(contact_id) {
    swal({
        ...
        if (willDelete) {
            $.get("{{route('Client-Contact-Remove')}}", {
